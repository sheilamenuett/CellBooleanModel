...
MaxZ = 3
#Net = 3
#cellName = BUF_X2_DFINH_combined
#Initialize poly
...
# AIL1(14,14,1,10) ==> AIL1(14,14,24,33)   Form(minX, maxX, minY, maxY)
...
for x in range(14,14+1):
  for y in range(1,10+1) :
    outLayout[x][y][0][0] = 3
Edge_Net_Subnet3[14,24:34,0,0,1,0] = exprones(10)
Edge_Net_Subnet3[14,24:34,0,0,2,0] = exprones(10)
Edge_Net[14,24:34,0,0,1,2] = exprones(10)
for x in range(14,14+1):
...
Net3_Subnet0_R1 = And(
	...
	RConstraints.R1(Edge_Net_Subnet3,[14,24,0,0, 14,25,0,0, 14,26,0,0, 14,27,0,0, 14,28,0,0, 14,29,0,0, 14,30,0,0, 14,31,0,0, 14,32,0,0, 14,33,0,0, ],10,10,0,1,18,35,3,0),
	).to_cnf()
Net3_Subnet0_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet3,Edge,Edge_Net,[14,1,0, 14,2,0, 14,3,0, 14,4,0, 14,5,0, 14,6,0, 14,7,0, 14,8,0, 14,9,0, 14,10,0, 14,11,0, 14,24,0, 14,25,0, 14,26,0, 14,27,0, 14,28,0, 14,29,0, 14,30,0, 14,31,0, 14,32,0, 14,33,0, 14,34,0, ],22,10,0,0,18,35,3,0,2),
	)
Net3_Subnet0_R3 = And(
