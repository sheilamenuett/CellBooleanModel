            ...
            if z == maxZ :
              ...
              Result += Or(
                           NHot(
                                ...
                                VarName[x,y,z,0,mask,sn],
                                VarName[x,y,z,1,mask,sn],
                                VarName[x,y,z2,2,mask,sn]
                                ),
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            else:
              print('1.1_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            indexOfResult += 1
          #case2
          ...
          #case4
            ...
            if z == maxZ and y == maxY:
              ...
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,1,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif z == maxZ:
              print('4.1_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif y == maxY:
              print('4.2_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,1,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            else:
              print('4.3_[',x,', ',y,', ',z,'] ')  
              Result += Or(
                           OneHot(
                                  ...
                                  And(VarName[x,y,z,0,mask,sn],VarName[x,y,z2,2,mask,sn]),
                                  And(VarName[x,y,z,1,mask,sn],VarName[x,y,z,2,mask,sn]),
                                  And(VarName[x,y,z,1,mask,sn],VarName[x,y2,z,0,mask,sn]),
                                  And(VarName[x,y,z,1,mask,sn],VarName[x,y,z2,2,mask,sn]),
                                  And(VarName[x,y,z,2,mask,sn],VarName[x,y2,z,0,mask,sn]),
                                  And(VarName[x,y,z,2,mask,sn], VarName[x,y,z2,2,mask,sn]),
                                  And(VarName[x,y2,z,0,mask,sn], VarName[x,y,z2,2,mask,sn]),
                                 ),
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()      
          ...
          #case5
            ...
            if x == maxX and z == maxZ :
              ...
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif x == maxX :
              print('5.1_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif z == maxZ :
              print('5.2_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            else :
              print('5.3_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           OneHot(
                                  ...
                                  And(VarName[x,y,z,2,mask,sn], VarName[x,y,z2,2,mask,sn]),
                                  And(VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                                 ),
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            indexOfResult += 1    
          ...
          #case7
            ...
            if [x,y,z] == [maxX, maxY, maxZ] :
              ...
              Result += Or(
                           ...
                           ~Or(VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif [x,y] == [maxX, maxY] :
              print('7.1_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,2,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif [x,z] == [maxX, maxZ] :
              print('7.2_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif [y,z] == [maxY, maxZ] :
              print('7.3_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,1,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif x == maxX :
              print('7.4_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            elif y == maxY :
              print('7.5_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,1,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()         
            elif z == maxZ :
              print('7.6_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()          
            else : 
              print('7.7_[',x,', ',y,', ',z,'] ')
              Result += Or(
                           ...
                           ~Or(VarName[x,y,z,0,mask,sn], VarName[x,y,z,1,mask,sn], VarName[x,y,z,2,mask,sn], VarName[x,y2,z,0,mask,sn], VarName[x2,y,z,1,mask,sn], VarName[x,y,z2,2,mask,sn])
                          ).to_cnf()
            indexOfResult += 1
        z += 1   
      y +=1
