...
# Trends Index => 0: Vertical | 1: Horizontal | 2: Orthogonal
Edge_Net = exprvars('edge_net', 34, 36, 4, 3, 3, 6)
...
Edge_Net_Subnet2 = exprvars('edge_net_subnet2', 34, 36, 4, 3, 3, 4)
...
MaxZ = 3
#Net = 6
#cellName = OR4_X1_DFINH_combined
#Initialize poly
...
### Disable edges outside window
Edge_Net_Subnet2[14:33+1,0:35+1,0:3+1,0:2+1,0:2+1,1]=exprzeros(25920)
...
# Range R2(4,4,0,35)
### Disable edges outside window
Edge_Net_Subnet2[14:33+1,0:35+1,0:3+1,0:2+1,0:2+1,2]=exprzeros(25920)
...
Edge_Net_Subnet2[22:33+1,0:35+1,0:3+1,0:2+1,0:2+1,3]=exprzeros(15552)
...
Net2_Subnet3_R3 = And(
	...
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(2,5+1)])for x in range(6,22+1)])for y in range(18,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)])	).to_cnf()
