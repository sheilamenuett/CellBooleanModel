...
# Trends Index => 0: Vertical | 1: Horizontal | 2: Orthogonal
Edge_Net_Subnet1 = exprvars('edge_net_subnet1', 18, 36, 4, 3, 3, 1)
...
MaxZ = 3
#Net = 2
#cellName = INV_X1_DFINH_combined
#Initialize poly
...
Edge_Net_Subnet1[6:17+1,0:35+1,0:3+1,0:2+1,0:2+1,0]=exprzeros(15552)
