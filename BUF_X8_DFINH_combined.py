...
# Trends Index => 0: Vertical | 1: Horizontal | 2: Orthogonal
Edge_Net = exprvars('edge_net', 70, 36, 4, 3, 3, 3)

# ===> Instruction(Create)  2D Routing Style p(e,n,s) <===
# ===> Edge_Net_Subnet_NetID[X, Y, Z, Trends, Masks, Subnets]
# Trends Index => 0: Vertical | 1: Horizontal | 2: Orthogonal
Edge_Net_Subnet1 = exprvars('edge_net_subnet1', 70, 36, 4, 3, 3, 9)
Edge_Net_Subnet2 = exprvars('edge_net_subnet2', 70, 36, 4, 3, 3, 19)
...
MaxZ = 3
#Net = 3
#cellName = BUF_X8_DFINH_combined
#Initialize poly
...
for x in range(26,26+1):
  for y in range(1,14+1) :
    outLayout[x][y][0][0] = 1
# Net-1 subNet-6 Terminal[3] to Terminal[8]
...
for x in range(30,30+1):
  for y in range(1,8+1) :
    outLayout[x][y][0][0] = 1
# Net-1 subNet-8 Terminal[4] to Terminal[9]
# AIL1(30,30,1,8) ==> AIL1(30,30,26,33)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet1[30,1:9,0,0,1,8] = exprones(8)
Edge_Net_Subnet1[30,1:9,0,0,2,8] = exprones(8)
Edge_Net[30,1:9,0,0,1,0] = exprones(8)
for x in range(30,30+1):
  for y in range(1,8+1) :
    outLayout[x][y][0][0] = 1
Edge_Net_Subnet1[30,26:34,0,0,1,8] = exprones(8)
Edge_Net_Subnet1[30,26:34,0,0,2,8] = exprones(8)
Edge_Net[30,26:34,0,0,1,0] = exprones(8)
for x in range(30,30+1):
  for y in range(26,33+1) :
    outLayout[x][y][0][0] = 1
# Net-2 subNet-0 Terminal[0] to Terminal[10]
...
for x in range(8,8+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-2 Terminal[1] to Terminal[11]
...
for x in range(12,12+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-4 Terminal[2] to Terminal[12]
...
for x in range(16,16+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-6 Terminal[3] to Terminal[13]
...
for x in range(20,20+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-8 Terminal[4] to Terminal[14]
...
for x in range(24,24+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-10 Terminal[5] to Terminal[15]
...
for x in range(24,24+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-11 Terminal[11] to Terminal[0]
...
for x in range(32,32+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-13 Terminal[6] to Terminal[16]
...
for x in range(32,32+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-14 Terminal[6] to Terminal[7]
# Poly(32,32,0,35) ==> AIL1(42,42,1,4)   Form(minX, maxX, minY, maxY)
...
for x in range(32,32+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 2
Edge_Net_Subnet2[42,1:5,0,0,1,14] = exprones(4)
Edge_Net_Subnet2[42,1:5,0,0,2,14] = exprones(4)
Edge_Net[42,1:5,0,0,1,1] = exprones(4)
for x in range(42,42+1):
  for y in range(1,4+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-15 Terminal[7] to Terminal[17]
# AIL1(42,42,1,4) ==> AIL1(42,42,30,33)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet2[42,1:5,0,0,1,15] = exprones(4)
Edge_Net_Subnet2[42,1:5,0,0,2,15] = exprones(4)
Edge_Net[42,1:5,0,0,1,1] = exprones(4)
for x in range(42,42+1):
  for y in range(1,4+1) :
    outLayout[x][y][0][0] = 2
Edge_Net_Subnet2[42,30:34,0,0,1,15] = exprones(4)
Edge_Net_Subnet2[42,30:34,0,0,2,15] = exprones(4)
Edge_Net[42,30:34,0,0,1,1] = exprones(4)
for x in range(42,42+1):
  for y in range(30,33+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-16 Terminal[7] to Terminal[8]
# AIL1(42,42,1,4) ==> AIL1(46,46,1,14)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet2[42,1:5,0,0,1,16] = exprones(4)
Edge_Net_Subnet2[42,1:5,0,0,2,16] = exprones(4)
Edge_Net[42,1:5,0,0,1,1] = exprones(4)
for x in range(42,42+1):
  for y in range(1,4+1) :
    outLayout[x][y][0][0] = 2
Edge_Net_Subnet2[46,1:15,0,0,1,16] = exprones(14)
Edge_Net_Subnet2[46,1:15,0,0,2,16] = exprones(14)
Edge_Net[46,1:15,0,0,1,1] = exprones(14)
for x in range(46,46+1):
  for y in range(1,14+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-17 Terminal[8] to Terminal[18]
# AIL1(46,46,1,14) ==> AIL1(46,46,20,33)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet2[46,1:15,0,0,1,17] = exprones(14)
Edge_Net_Subnet2[46,1:15,0,0,2,17] = exprones(14)
Edge_Net[46,1:15,0,0,1,1] = exprones(14)
for x in range(46,46+1):
  for y in range(1,14+1) :
    outLayout[x][y][0][0] = 2
Edge_Net_Subnet2[46,20:34,0,0,1,17] = exprones(14)
Edge_Net_Subnet2[46,20:34,0,0,2,17] = exprones(14)
Edge_Net[46,20:34,0,0,1,1] = exprones(14)
for x in range(46,46+1):
  for y in range(20,33+1) :
    outLayout[x][y][0][0] = 2
# Net-2 subNet-18 Terminal[8] to Terminal[9]
# AIL1(46,46,1,14) ==> AIL1(54,54,1,14)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet2[46,1:15,0,0,1,18] = exprones(14)
Edge_Net_Subnet2[46,1:15,0,0,2,18] = exprones(14)
Edge_Net[46,1:15,0,0,1,1] = exprones(14)
for x in range(46,46+1):
  for y in range(1,14+1) :
    outLayout[x][y][0][0] = 2
Edge_Net_Subnet2[54,1:15,0,0,1,18] = exprones(14)
Edge_Net_Subnet2[54,1:15,0,0,2,18] = exprones(14)
Edge_Net[54,1:15,0,0,1,1] = exprones(14)
for x in range(54,54+1):
  for y in range(1,14+1) :
    outLayout[x][y][0][0] = 2
# Net-3 subNet-0 Terminal[0] to Terminal[4]
# Poly(40,40,0,35) ==> Poly(40,40,0,35)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet3[40,0:36,0,0,0,0] = exprones(36)
Edge_Net_Subnet3[40,0:36,0,0,2,0] = exprones(36)
...
Edge_Net_Subnet3[40,0:36,0,0,0,1] = exprones(36)
Edge_Net_Subnet3[40,0:36,0,0,2,1] = exprones(36)
Edge_Net[40,0:36,0,0,0,2] = exprones(36)
for x in range(40,40+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
Edge_Net_Subnet3[48,0:36,0,0,0,1] = exprones(36)
Edge_Net_Subnet3[48,0:36,0,0,2,1] = exprones(36)
Edge_Net[48,0:36,0,0,0,2] = exprones(36)
for x in range(48,48+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
# Net-3 subNet-2 Terminal[1] to Terminal[5]
# Poly(48,48,0,35) ==> Poly(48,48,0,35)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet3[48,0:36,0,0,0,2] = exprones(36)
Edge_Net_Subnet3[48,0:36,0,0,2,2] = exprones(36)
Edge_Net[48,0:36,0,0,0,2] = exprones(36)
for x in range(48,48+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
...
Edge_Net_Subnet3[48,0:36,0,0,0,3] = exprones(36)
Edge_Net_Subnet3[48,0:36,0,0,2,3] = exprones(36)
Edge_Net[48,0:36,0,0,0,2] = exprones(36)
for x in range(48,48+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
Edge_Net_Subnet3[52,0:36,0,0,0,3] = exprones(36)
Edge_Net_Subnet3[52,0:36,0,0,2,3] = exprones(36)
Edge_Net[52,0:36,0,0,0,2] = exprones(36)
for x in range(52,52+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
# Net-3 subNet-4 Terminal[2] to Terminal[6]
# Poly(52,52,0,35) ==> Poly(52,52,0,35)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet3[52,0:36,0,0,0,4] = exprones(36)
Edge_Net_Subnet3[52,0:36,0,0,2,4] = exprones(36)
Edge_Net[52,0:36,0,0,0,2] = exprones(36)
for x in range(52,52+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
...
Edge_Net_Subnet3[52,0:36,0,0,0,5] = exprones(36)
Edge_Net_Subnet3[52,0:36,0,0,2,5] = exprones(36)
Edge_Net[52,0:36,0,0,0,2] = exprones(36)
for x in range(52,52+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
Edge_Net_Subnet3[56,0:36,0,0,0,5] = exprones(36)
Edge_Net_Subnet3[56,0:36,0,0,2,5] = exprones(36)
Edge_Net[56,0:36,0,0,0,2] = exprones(36)
for x in range(56,56+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
# Net-3 subNet-6 Terminal[3] to Terminal[7]
# Poly(56,56,0,35) ==> Poly(56,56,0,35)   Form(minX, maxX, minY, maxY)
Edge_Net_Subnet3[56,0:36,0,0,0,6] = exprones(36)
Edge_Net_Subnet3[56,0:36,0,0,2,6] = exprones(36)
Edge_Net[56,0:36,0,0,0,2] = exprones(36)
for x in range(56,56+1):
  for y in range(0,35+1) :
    outLayout[x][y][0][0] = 3
...
Net1_Subnet0_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,0], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(0+1,9)]))for trend in range(0,1+1)])for x in range(0,6+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,0], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(0+1,9)]))for trend in range(0,1+1)])for x in range(0,6+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,1], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(1+1,9)]))for trend in range(0,1+1)])for x in range(0,14+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,1], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(1+1,9)]))for trend in range(0,1+1)])for x in range(0,14+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
).to_cnf()
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,2], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(2+1,9)]))for trend in range(0,1+1)])for x in range(6,14+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,2], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(2+1,9)]))for trend in range(0,1+1)])for x in range(6,14+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet1[22:69+1,0:35+1,0:3+1,0:2+1,0:2+1,3]=exprzeros(62208)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,3], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(3+1,9)]))for trend in range(0,1+1)])for x in range(6,22+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,3], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(3+1,9)]))for trend in range(0,1+1)])for x in range(6,22+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet1[22:69+1,0:35+1,0:3+1,0:2+1,0:2+1,4]=exprzeros(62208)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,4], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(4+1,9)]))for trend in range(0,1+1)])for x in range(14,22+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,4], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(4+1,9)]))for trend in range(0,1+1)])for x in range(14,22+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet1[30:69+1,0:35+1,0:3+1,0:2+1,0:2+1,5]=exprzeros(51840)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,5], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(5+1,9)]))for trend in range(0,1+1)])for x in range(14,30+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,5], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(5+1,9)]))for trend in range(0,1+1)])for x in range(14,30+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net1_Subnet5_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,0],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(1,2+1)])for x in range(14,30+1)])for y in range(0,18+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	).to_cnf()
...
Edge_Net_Subnet1[30:69+1,0:35+1,0:3+1,0:2+1,0:2+1,6]=exprzeros(51840)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,6], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(6+1,9)]))for trend in range(0,1+1)])for x in range(22,30+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,6], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(6+1,9)]))for trend in range(0,1+1)])for x in range(22,30+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net1_Subnet6_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,0],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(1,2+1)])for x in range(22,30+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	).to_cnf()
...
# Net = 1 Subnet = 7 | Left -> Right [22,34] Top -> Bottom [0,18]
# Range R1(26,26,1,14)
# Range R2(30,30,1,8)
### Disable edges outside window
Edge_Net_Subnet1[0:22,0:35+1,0:3+1,0:2+1,0:2+1,7]=exprzeros(28512)
Edge_Net_Subnet1[22:34,18:35+1,0:3+1,0:2+1,0:2+1,7]=exprzeros(7776)
Edge_Net_Subnet1[34:69+1,0:35+1,0:3+1,0:2+1,0:2+1,7]=exprzeros(46656)

### Consistency Constraints
Net1_Subnet7_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,0]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(22,34+1)])for y in range(0,18+1)])for z in range(0,3+1)]).to_cnf()
Net1_Subnet7_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet1[x,y,z,trend,mask,7]), Edge_Net[x,y,z,trend,mask,0])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(22,34+1)])for y in range(0,18+1)])for z in range(0,3+1)]).to_cnf()
Net1_Subnet7_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet1[x,y,2,trend,0,7],Xor(Edge_Net_Subnet1[x,y,2,trend,1,7],Edge_Net_Subnet1[x,y,2,trend,2,7])),And(~Edge_Net_Subnet1[x,y,2,trend,0,7],~Edge_Net_Subnet1[x,y,2,trend,1,7],~Edge_Net_Subnet1[x,y,2,trend,2,7]))for x in range(22,34+1)])for y in range(0,18+1)])for trend in range(0,1+1)]).to_cnf()
Net1_Subnet7_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet1[x,y,3,1,0,7],Xor(Edge_Net_Subnet1[x,y,3,1,1,7],Edge_Net_Subnet1[x,y,3,1,2,7])),And(~Edge_Net_Subnet1[x,y,3,1,0,7],~Edge_Net_Subnet1[x,y,3,1,1,7],~Edge_Net_Subnet1[x,y,3,1,2,7]))for x in range(22,34+1)])for y in range(0,18+1)]).to_cnf()
Net1_Subnet7_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet1[x,y,1,trend,2,7],Xor(Edge_Net_Subnet1[x,y,1,trend,0,7],Edge_Net_Subnet1[x,y,1,trend,1,7])),And(~Edge_Net_Subnet1[x,y,1,trend,2,7],~Edge_Net_Subnet1[x,y,1,trend,0,7],~Edge_Net_Subnet1[x,y,1,trend,1,7]))for x in range(22,34+1)])for y in range(0,18+1)])for trend in range(0,1+1)]).to_cnf()
Net1_Subnet7_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,7], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(0,7)]))for trend in range(0,1+1)])for x in range(22,34+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,7], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(7+1,9)]))for trend in range(0,1+1)])for x in range(22,34+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,7], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(0,7)]))for trend in range(0,1+1)])for x in range(22,34+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,7], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(7+1,9)]))for trend in range(0,1+1)])for x in range(22,34+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net1_Subnet7_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet1[x,y,1,1,1,7], ~Edge_Net_Subnet1[x-1,y,1,1,1,7]), And(Edge_Net_Subnet1[x+1,y,1,1,1,7], Edge_Net_Subnet1[x+2,y,1,1,1,7], Edge_Net_Subnet1[x+3,y,1,1,1,7], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet1[x,y,1,1,1,7], ~Edge_Net_Subnet1[x+1,y,1,1,1,7]), And(Edge_Net_Subnet1[x-1,y,1,1,1,7], Edge_Net_Subnet1[x-2,y,1,1,1,7], Edge_Net_Subnet1[x-3,y,1,1,1,7], ))for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,1,1,7], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,1,1,7], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,1,1,7], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,1,1,7], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(22,34+1)])for y in range(3,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,7]), And(Edge_Net_Subnet1[x,y+1,1,0,0,7], Edge_Net_Subnet1[x,y+2,1,0,0,7], Edge_Net_Subnet1[x,y+3,1,0,0,7], ))for x in range(22,34+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,7], ~Edge_Net_Subnet1[x,y-1,1,0,0,7]), And(Edge_Net_Subnet1[x,y+1,1,0,0,7], Edge_Net_Subnet1[x,y+2,1,0,0,7], Edge_Net_Subnet1[x,y+3,1,0,0,7], ))for x in range(22,34+1)])for y in range(0+1,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,7], ~Edge_Net_Subnet1[x,y+1,1,0,0,7]), And(Edge_Net_Subnet1[x,y-1,1,0,0,7], Edge_Net_Subnet1[x,y-2,1,0,0,7], Edge_Net_Subnet1[x,y-3,1,0,0,7], ))for x in range(22,34+1)])for y in range(0+3,18+1)])
	).to_cnf()
Net1_Subnet7_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,7], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(22,34+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,7], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(22,34+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,7], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(22,34+1)])for y in range(0+3,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,7], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(22,34+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net1_Subnet7_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,0,0,7], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,0,0,7], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	).to_cnf()
...
Net1_Subnet7_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,mask,7], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,mask,7], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(3,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,mask,7], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,mask,7], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,1,7], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,1,7], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(22,34+1)])for y in range(2,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,1,7], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,1,7], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,mask,7], And(Edge_Net_Subnet1[x+1,y,2,1,mask,7], Edge_Net_Subnet1[x+2,y,2,1,mask,7], Edge_Net_Subnet1[x+3,y,2,1,mask,7], Edge_Net_Subnet1[x+4,y,2,1,mask,7], Edge_Net_Subnet1[x+5,y,2,1,mask,7], ))for mask in range(1,2+1)])for x in range(34-1,22)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,7], ~Edge_Net_Subnet1[x,y-1,2,0,mask,7]), And(Edge_Net_Subnet1[x,y+1,2,0,mask,7], Edge_Net_Subnet1[x,y+2,2,0,mask,7], Edge_Net_Subnet1[x,y+3,2,0,mask,7], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0+1,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,7], ~Edge_Net_Subnet1[x,y+1,2,0,mask,7]), And(Edge_Net_Subnet1[x,y-1,2,0,mask,7], Edge_Net_Subnet1[x,y-2,2,0,mask,7], Edge_Net_Subnet1[x,y-3,2,0,mask,7], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0+3,18+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet1[x,y,2,0,mask,7], And(Edge_Net_Subnet1[x,y+1,2,0,mask,7], Edge_Net_Subnet1[x,y+2,2,0,mask,7], Edge_Net_Subnet1[x,y+3,2,0,mask,7], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet1[x,y,2,0,mask,7], And(Edge_Net_Subnet1[x,y-1,2,0,mask,7], Edge_Net_Subnet1[x,y-2,2,0,mask,7], Edge_Net_Subnet1[x,y-3,2,0,mask,7], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(18,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,1,7], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,1,7], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,mask,7], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,mask,7], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,1,7], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(22,34+1)])for y in range(2,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,1,7], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,7], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(4,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,7], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,1,7], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,1,7], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(22,34+1)])for y in range(3,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,mask,7], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,mask,7], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(4,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,1,7], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,1,7], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(22,34+1)])for y in range(0,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,mask,7], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,mask,7], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,1,2,mask,7], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,1,2,mask,7], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,2,2,mask,7], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,2,2,mask,7], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(0,18+1)])
	).to_cnf()
Net1_Subnet7_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,2,mask,7], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,2,mask,7], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(2,18+1)]),
	).to_cnf()
Net1_Subnet7_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,2,mask,7], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,2,mask,7], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(22,34+1)])for y in range(2,18+1)]),
	).to_cnf()
...
### Routability Constraints
Net1_Subnet7_R1 = And(
	RConstraints.R1(Edge_Net_Subnet1,[26,1,0,0, 26,2,0,0, 26,3,0,0, 26,4,0,0, 26,5,0,0, 26,6,0,0, 26,7,0,0, 26,8,0,0, 26,9,0,0, 26,10,0,0, 26,11,0,0, 26,12,0,0, 26,13,0,0, 26,14,0,0, ],14,22,0,1,34,18,3,7),
	RConstraints.R1(Edge_Net_Subnet1,[30,1,0,0, 30,2,0,0, 30,3,0,0, 30,4,0,0, 30,5,0,0, 30,6,0,0, 30,7,0,0, 30,8,0,0, ],8,22,0,1,34,18,3,7),
	).to_cnf()
Net1_Subnet7_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet1,Edge,Edge_Net,[26,1,0, 26,2,0, 26,3,0, 26,4,0, 26,5,0, 26,6,0, 26,7,0, 26,8,0, 26,9,0, 26,10,0, 26,11,0, 26,12,0, 26,13,0, 26,14,0, 26,15,0, 30,1,0, 30,2,0, 30,3,0, 30,4,0, 30,5,0, 30,6,0, 30,7,0, 30,8,0, 30,9,0, ],24,22,0,0,34,18,3,7,0),
	)
Net1_Subnet7_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,0],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(1,2+1)])for x in range(22,34+1)])for y in range(0,18+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	).to_cnf()
...
# Net = 1 Subnet = 8 | Left -> Right [26,34] Top -> Bottom [0,35]
# Range R1(30,30,1,8)
# Range R2(30,30,26,33)
### Disable edges outside window
Edge_Net_Subnet1[0:26,0:35+1,0:3+1,0:2+1,0:2+1,8]=exprzeros(33696)
Edge_Net_Subnet1[34:69+1,0:35+1,0:3+1,0:2+1,0:2+1,8]=exprzeros(46656)

### Consistency Constraints
Net1_Subnet8_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,0]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(26,34+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net1_Subnet8_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet1[x,y,z,trend,mask,8]), Edge_Net[x,y,z,trend,mask,0])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(26,34+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net1_Subnet8_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet1[x,y,2,trend,0,8],Xor(Edge_Net_Subnet1[x,y,2,trend,1,8],Edge_Net_Subnet1[x,y,2,trend,2,8])),And(~Edge_Net_Subnet1[x,y,2,trend,0,8],~Edge_Net_Subnet1[x,y,2,trend,1,8],~Edge_Net_Subnet1[x,y,2,trend,2,8]))for x in range(26,34+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net1_Subnet8_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet1[x,y,3,1,0,8],Xor(Edge_Net_Subnet1[x,y,3,1,1,8],Edge_Net_Subnet1[x,y,3,1,2,8])),And(~Edge_Net_Subnet1[x,y,3,1,0,8],~Edge_Net_Subnet1[x,y,3,1,1,8],~Edge_Net_Subnet1[x,y,3,1,2,8]))for x in range(26,34+1)])for y in range(0,35+1)]).to_cnf()
Net1_Subnet8_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet1[x,y,1,trend,2,8],Xor(Edge_Net_Subnet1[x,y,1,trend,0,8],Edge_Net_Subnet1[x,y,1,trend,1,8])),And(~Edge_Net_Subnet1[x,y,1,trend,2,8],~Edge_Net_Subnet1[x,y,1,trend,0,8],~Edge_Net_Subnet1[x,y,1,trend,1,8]))for x in range(26,34+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net1_Subnet8_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,1,8], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,2,s2])for s2 in range(0,8)]))for trend in range(0,1+1)])for x in range(26,34+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,z,trend,2,8], And(*[And(~Edge_Net_Subnet1[x,y,z,trend,1,s2])for s2 in range(0,8)]))for trend in range(0,1+1)])for x in range(26,34+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net1_Subnet8_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet1[x,y,1,1,1,8], ~Edge_Net_Subnet1[x-1,y,1,1,1,8]), And(Edge_Net_Subnet1[x+1,y,1,1,1,8], Edge_Net_Subnet1[x+2,y,1,1,1,8], Edge_Net_Subnet1[x+3,y,1,1,1,8], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet1[x,y,1,1,1,8], ~Edge_Net_Subnet1[x+1,y,1,1,1,8]), And(Edge_Net_Subnet1[x-1,y,1,1,1,8], Edge_Net_Subnet1[x-2,y,1,1,1,8], Edge_Net_Subnet1[x-3,y,1,1,1,8], ))for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,1,1,8], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,1,1,8], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,1,1,8], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(26,34+1)])for y in range(0,32+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,1,1,8], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(26,34+1)])for y in range(3,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8]), And(Edge_Net_Subnet1[x,y+1,1,0,0,8], Edge_Net_Subnet1[x,y+2,1,0,0,8], Edge_Net_Subnet1[x,y+3,1,0,0,8], ))for x in range(26,34+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8]), And(Edge_Net_Subnet1[x,y-1,1,0,0,8], Edge_Net_Subnet1[x,y-2,1,0,0,8], Edge_Net_Subnet1[x,y-3,1,0,0,8], ))for x in range(26,34+1)])for y in range(35,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge_Net_Subnet1[x,y-1,1,0,0,8]), And(Edge_Net_Subnet1[x,y+1,1,0,0,8], Edge_Net_Subnet1[x,y+2,1,0,0,8], Edge_Net_Subnet1[x,y+3,1,0,0,8], ))for x in range(26,34+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge_Net_Subnet1[x,y+1,1,0,0,8]), And(Edge_Net_Subnet1[x,y-1,1,0,0,8], Edge_Net_Subnet1[x,y-2,1,0,0,8], Edge_Net_Subnet1[x,y-3,1,0,0,8], ))for x in range(26,34+1)])for y in range(0+3,35-1+1)])
	).to_cnf()
Net1_Subnet8_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(26,34+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(26,34+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ))for x in range(26,34+1)])for y in range(35-1,35-1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+2,1,0,0], ~Edge[x,y+1,1,0,0], ))for x in range(26,34+1)])for y in range(35-2,35-2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(26,34+1)])for y in range(0+3,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,1,0,0,8], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(26,34+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net1_Subnet8_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,0,0,8], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,0,0,8], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	).to_cnf()
...
Net1_Subnet8_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,mask,8], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,32+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,mask,8], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(3,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,mask,8], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,mask,8], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,1,8], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(26,34+1)])for y in range(0,33+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,3,1,1,8], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(26,34+1)])for y in range(2,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,1,8], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,3,1,1,8], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet1[x,y,2,1,mask,8], ~Edge_Net_Subnet1[x+1,y,2,1,mask,8]), And(Edge_Net_Subnet1[x-1,y,2,1,mask,8], Edge_Net_Subnet1[x-2,y,2,1,mask,8], Edge_Net_Subnet1[x-3,y,2,1,mask,8], Edge_Net_Subnet1[x-4,y,2,1,mask,8], Edge_Net_Subnet1[x-5,y,2,1,mask,8], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,mask,8], And(Edge_Net_Subnet1[x-1,y,2,1,mask,8], Edge_Net_Subnet1[x-2,y,2,1,mask,8], Edge_Net_Subnet1[x-3,y,2,1,mask,8], Edge_Net_Subnet1[x-4,y,2,1,mask,8], Edge_Net_Subnet1[x-5,y,2,1,mask,8], ))for mask in range(1,2+1)])for x in range(26,26+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,mask,8], And(Edge_Net_Subnet1[x+1,y,2,1,mask,8], Edge_Net_Subnet1[x+2,y,2,1,mask,8], Edge_Net_Subnet1[x+3,y,2,1,mask,8], Edge_Net_Subnet1[x+4,y,2,1,mask,8], Edge_Net_Subnet1[x+5,y,2,1,mask,8], ))for mask in range(1,2+1)])for x in range(34-1,26)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,8], ~Edge_Net_Subnet1[x,y-1,2,0,mask,8]), And(Edge_Net_Subnet1[x,y+1,2,0,mask,8], Edge_Net_Subnet1[x,y+2,2,0,mask,8], Edge_Net_Subnet1[x,y+3,2,0,mask,8], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,8], ~Edge_Net_Subnet1[x,y+1,2,0,mask,8]), And(Edge_Net_Subnet1[x,y-1,2,0,mask,8], Edge_Net_Subnet1[x,y-2,2,0,mask,8], Edge_Net_Subnet1[x,y-3,2,0,mask,8], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0+3,35-1+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet1[x,y,2,0,mask,8], And(Edge_Net_Subnet1[x,y+1,2,0,mask,8], Edge_Net_Subnet1[x,y+2,2,0,mask,8], Edge_Net_Subnet1[x,y+3,2,0,mask,8], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet1[x,y,2,0,mask,8], And(Edge_Net_Subnet1[x,y-1,2,0,mask,8], Edge_Net_Subnet1[x,y-2,2,0,mask,8], Edge_Net_Subnet1[x,y-3,2,0,mask,8], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(35,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,1,8], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,1,8], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,mask,8], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,1,mask,8], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,1,8], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(26,34+1)])for y in range(2,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,1,8], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(26,34+1)])for y in range(0,35-2+1)]),
	).to_cnf()
Net1_Subnet8_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,8], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(4,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet1[x,y,2,0,mask,8], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35-4+1)]),
	).to_cnf()
Net1_Subnet8_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,1,8], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(26,34+1)])for y in range(0,35-3+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,1,8], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(26,34+1)])for y in range(3,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,mask,8], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35-4+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,1,mask,8], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(4,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,1,8], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,1,8], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(26,34+1)])for y in range(0,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,mask,8], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,0,mask,8], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,1,2,mask,8], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,1,2,mask,8], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,2,2,mask,8], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet1[x,y,2,2,mask,8], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(0,35+1)])
	).to_cnf()
Net1_Subnet8_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,2,mask,8], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,1,2,mask,8], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(2,35+1)]),
	).to_cnf()
Net1_Subnet8_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,2,mask,8], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet1[x,y,2,2,mask,8], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(26,34+1)])for y in range(2,35+1)]),
	).to_cnf()
...
### Routability Constraints
Net1_Subnet8_R1 = And(
	RConstraints.R1(Edge_Net_Subnet1,[30,1,0,0, 30,2,0,0, 30,3,0,0, 30,4,0,0, 30,5,0,0, 30,6,0,0, 30,7,0,0, 30,8,0,0, ],8,26,0,1,34,35,3,8),
	RConstraints.R1(Edge_Net_Subnet1,[30,26,0,0, 30,27,0,0, 30,28,0,0, 30,29,0,0, 30,30,0,0, 30,31,0,0, 30,32,0,0, 30,33,0,0, ],8,26,0,1,34,35,3,8),
	).to_cnf()
Net1_Subnet8_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet1,Edge,Edge_Net,[30,1,0, 30,2,0, 30,3,0, 30,4,0, 30,5,0, 30,6,0, 30,7,0, 30,8,0, 30,9,0, 30,26,0, 30,27,0, 30,28,0, 30,29,0, 30,30,0, 30,31,0, 30,32,0, 30,33,0, 30,34,0, ],18,26,0,0,34,35,3,8,0),
	)
Net1_Subnet8_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,0],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(1,2+1)])for x in range(26,34+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	).to_cnf()
...
# Range R2(8,8,0,35)
### Disable edges outside window
Edge_Net_Subnet2[12:69+1,0:35+1,0:3+1,0:2+1,0:2+1,1]=exprzeros(75168)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,1], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(1+1,19)]))for trend in range(0,1+1)])for x in range(0,12+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,1], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(1+1,19)]))for trend in range(0,1+1)])for x in range(0,12+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet2[16:69+1,0:35+1,0:3+1,0:2+1,0:2+1,3]=exprzeros(69984)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,3], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(3+1,19)]))for trend in range(0,1+1)])for x in range(4,16+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,3], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(3+1,19)]))for trend in range(0,1+1)])for x in range(4,16+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet2[20:69+1,0:35+1,0:3+1,0:2+1,0:2+1,5]=exprzeros(64800)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,5], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(5+1,19)]))for trend in range(0,1+1)])for x in range(8,20+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,5], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(5+1,19)]))for trend in range(0,1+1)])for x in range(8,20+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet2[24:69+1,0:35+1,0:3+1,0:2+1,0:2+1,7]=exprzeros(59616)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,7], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(7+1,19)]))for trend in range(0,1+1)])for x in range(12,24+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,7], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(7+1,19)]))for trend in range(0,1+1)])for x in range(12,24+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet2[28:69+1,0:35+1,0:3+1,0:2+1,0:2+1,9]=exprzeros(54432)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,9], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(9+1,19)]))for trend in range(0,1+1)])for x in range(16,28+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,9], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(9+1,19)]))for trend in range(0,1+1)])for x in range(16,28+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
# Range R2(4,4,0,35)
### Disable edges outside window
Edge_Net_Subnet2[12:69+1,0:35+1,0:3+1,0:2+1,0:2+1,11]=exprzeros(75168)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,11], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(11+1,19)]))for trend in range(0,1+1)])for x in range(0,12+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,11], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(11+1,19)]))for trend in range(0,1+1)])for x in range(0,12+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Edge_Net_Subnet2[36:69+1,0:35+1,0:3+1,0:2+1,0:2+1,12]=exprzeros(44064)
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,12], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(12+1,19)]))for trend in range(0,1+1)])for x in range(20,36+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
...
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,12], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(12+1,19)]))for trend in range(0,1+1)])for x in range(20,36+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net2_Subnet12_R3 = And(
	...
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(2,2+1)])for x in range(20,36+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)])	).to_cnf()
...
# Net = 2 Subnet = 14 | Left -> Right [28,46] Top -> Bottom [0,35]
# Range R1(32,32,0,35)
# Range R2(42,42,1,4)
### Disable edges outside window
Edge_Net_Subnet2[0:28,0:35+1,0:3+1,0:2+1,0:2+1,14]=exprzeros(36288)
Edge_Net_Subnet2[46:69+1,0:35+1,0:3+1,0:2+1,0:2+1,14]=exprzeros(31104)

### Consistency Constraints
Net2_Subnet14_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,1]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet14_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet2[x,y,z,trend,mask,14]), Edge_Net[x,y,z,trend,mask,1])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet14_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,2,trend,0,14],Xor(Edge_Net_Subnet2[x,y,2,trend,1,14],Edge_Net_Subnet2[x,y,2,trend,2,14])),And(~Edge_Net_Subnet2[x,y,2,trend,0,14],~Edge_Net_Subnet2[x,y,2,trend,1,14],~Edge_Net_Subnet2[x,y,2,trend,2,14]))for x in range(28,46+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet14_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,3,1,0,14],Xor(Edge_Net_Subnet2[x,y,3,1,1,14],Edge_Net_Subnet2[x,y,3,1,2,14])),And(~Edge_Net_Subnet2[x,y,3,1,0,14],~Edge_Net_Subnet2[x,y,3,1,1,14],~Edge_Net_Subnet2[x,y,3,1,2,14]))for x in range(28,46+1)])for y in range(0,35+1)]).to_cnf()
Net2_Subnet14_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,1,trend,2,14],Xor(Edge_Net_Subnet2[x,y,1,trend,0,14],Edge_Net_Subnet2[x,y,1,trend,1,14])),And(~Edge_Net_Subnet2[x,y,1,trend,2,14],~Edge_Net_Subnet2[x,y,1,trend,0,14],~Edge_Net_Subnet2[x,y,1,trend,1,14]))for x in range(28,46+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet14_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,14], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(0,14)]))for trend in range(0,1+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,14], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(14+1,19)]))for trend in range(0,1+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,14], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(0,14)]))for trend in range(0,1+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,14], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(14+1,19)]))for trend in range(0,1+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net2_Subnet14_DR_Trend = And(
	And(*[And(*[Not(Edge[x,y,1,0,1])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[Not(Edge[x,y,1,1,0])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Not(Edge[x,y,3,0,mask])for x in range(28,46+1)])for y in range(0,35+1)])for mask in range(0,2+1)])
	).to_cnf()
Net2_Subnet14_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,14], ~Edge_Net_Subnet2[x-1,y,1,1,1,14]), And(Edge_Net_Subnet2[x+1,y,1,1,1,14], Edge_Net_Subnet2[x+2,y,1,1,1,14], Edge_Net_Subnet2[x+3,y,1,1,1,14], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,14], ~Edge_Net_Subnet2[x+1,y,1,1,1,14]), And(Edge_Net_Subnet2[x-1,y,1,1,1,14], Edge_Net_Subnet2[x-2,y,1,1,1,14], Edge_Net_Subnet2[x-3,y,1,1,1,14], ))for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,14], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,14], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,14], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(28,46+1)])for y in range(0,32+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,14], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(28,46+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14]), And(Edge_Net_Subnet2[x,y+1,1,0,0,14], Edge_Net_Subnet2[x,y+2,1,0,0,14], Edge_Net_Subnet2[x,y+3,1,0,0,14], ))for x in range(28,46+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14]), And(Edge_Net_Subnet2[x,y-1,1,0,0,14], Edge_Net_Subnet2[x,y-2,1,0,0,14], Edge_Net_Subnet2[x,y-3,1,0,0,14], ))for x in range(28,46+1)])for y in range(35,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge_Net_Subnet2[x,y-1,1,0,0,14]), And(Edge_Net_Subnet2[x,y+1,1,0,0,14], Edge_Net_Subnet2[x,y+2,1,0,0,14], Edge_Net_Subnet2[x,y+3,1,0,0,14], ))for x in range(28,46+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge_Net_Subnet2[x,y+1,1,0,0,14]), And(Edge_Net_Subnet2[x,y-1,1,0,0,14], Edge_Net_Subnet2[x,y-2,1,0,0,14], Edge_Net_Subnet2[x,y-3,1,0,0,14], ))for x in range(28,46+1)])for y in range(0+3,35-1+1)])
	).to_cnf()
Net2_Subnet14_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(28,46+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(28,46+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ))for x in range(28,46+1)])for y in range(35-1,35-1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+2,1,0,0], ~Edge[x,y+1,1,0,0], ))for x in range(28,46+1)])for y in range(35-2,35-2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(28,46+1)])for y in range(0+3,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,14], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(28,46+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net2_Subnet14_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,14], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,14], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_MINT1AB_HorMinWidth = And(
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,3,1,mask,14], ~Edge_Net_Subnet2[x-1,y,3,1,mask,14]), And(Edge_Net_Subnet2[x+1,y,3,1,mask,14], Edge_Net_Subnet2[x+2,y,3,1,mask,14], Edge_Net_Subnet2[x+3,y,3,1,mask,14], Edge_Net_Subnet2[x+4,y,3,1,mask,14], Edge_Net_Subnet2[x+5,y,3,1,mask,14], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,3,1,mask,14], ~Edge_Net_Subnet2[x+1,y,3,1,mask,14]), And(Edge_Net_Subnet2[x-1,y,3,1,mask,14], Edge_Net_Subnet2[x-2,y,3,1,mask,14], Edge_Net_Subnet2[x-3,y,3,1,mask,14], Edge_Net_Subnet2[x-4,y,3,1,mask,14], Edge_Net_Subnet2[x-5,y,3,1,mask,14], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,14], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,32+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,14], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,14], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,14], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,14], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(28,46+1)])for y in range(0,33+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,14], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(28,46+1)])for y in range(2,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,14], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,14], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,2,1,mask,14], ~Edge_Net_Subnet2[x+1,y,2,1,mask,14]), And(Edge_Net_Subnet2[x-1,y,2,1,mask,14], Edge_Net_Subnet2[x-2,y,2,1,mask,14], Edge_Net_Subnet2[x-3,y,2,1,mask,14], Edge_Net_Subnet2[x-4,y,2,1,mask,14], Edge_Net_Subnet2[x-5,y,2,1,mask,14], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,14], And(Edge_Net_Subnet2[x-1,y,2,1,mask,14], Edge_Net_Subnet2[x-2,y,2,1,mask,14], Edge_Net_Subnet2[x-3,y,2,1,mask,14], Edge_Net_Subnet2[x-4,y,2,1,mask,14], Edge_Net_Subnet2[x-5,y,2,1,mask,14], ))for mask in range(1,2+1)])for x in range(28,28+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,14], And(Edge_Net_Subnet2[x+1,y,2,1,mask,14], Edge_Net_Subnet2[x+2,y,2,1,mask,14], Edge_Net_Subnet2[x+3,y,2,1,mask,14], Edge_Net_Subnet2[x+4,y,2,1,mask,14], Edge_Net_Subnet2[x+5,y,2,1,mask,14], ))for mask in range(1,2+1)])for x in range(46-1,28)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,14], ~Edge_Net_Subnet2[x,y-1,2,0,mask,14]), And(Edge_Net_Subnet2[x,y+1,2,0,mask,14], Edge_Net_Subnet2[x,y+2,2,0,mask,14], Edge_Net_Subnet2[x,y+3,2,0,mask,14], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,14], ~Edge_Net_Subnet2[x,y+1,2,0,mask,14]), And(Edge_Net_Subnet2[x,y-1,2,0,mask,14], Edge_Net_Subnet2[x,y-2,2,0,mask,14], Edge_Net_Subnet2[x,y-3,2,0,mask,14], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0+3,35-1+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,14], And(Edge_Net_Subnet2[x,y+1,2,0,mask,14], Edge_Net_Subnet2[x,y+2,2,0,mask,14], Edge_Net_Subnet2[x,y+3,2,0,mask,14], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,14], And(Edge_Net_Subnet2[x,y-1,2,0,mask,14], Edge_Net_Subnet2[x,y-2,2,0,mask,14], Edge_Net_Subnet2[x,y-3,2,0,mask,14], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(35,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,14], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,14], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,14], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,14], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,14], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(28,46+1)])for y in range(2,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,14], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(28,46+1)])for y in range(0,35-2+1)]),
	).to_cnf()
Net2_Subnet14_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,14], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(4,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,14], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35-4+1)]),
	).to_cnf()
Net2_Subnet14_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,14], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(28,46+1)])for y in range(0,35-3+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,14], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(28,46+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,14], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35-4+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,14], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(4,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,14], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,14], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(28,46+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,14], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,14], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,14], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,14], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,14], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,14], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet14_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,14], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,14], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(2,35+1)]),
	).to_cnf()
Net2_Subnet14_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,14], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,14], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(28,46+1)])for y in range(2,35+1)]),
	).to_cnf()
...
Net2_Subnet14_R1 = And(
	RConstraints.R1(Edge_Net_Subnet2,[32,0,0,0, 32,1,0,0, 32,2,0,0, 32,3,0,0, 32,4,0,0, 32,5,0,0, 32,6,0,0, 32,7,0,0, 32,8,0,0, 32,9,0,0, 32,10,0,0, 32,11,0,0, 32,12,0,0, 32,13,0,0, 32,14,0,0, 32,15,0,0, 32,16,0,0, 32,17,0,0, 32,18,0,0, 32,19,0,0, 32,20,0,0, 32,21,0,0, 32,22,0,0, 32,23,0,0, 32,24,0,0, 32,25,0,0, 32,26,0,0, 32,27,0,0, 32,28,0,0, 32,29,0,0, 32,30,0,0, 32,31,0,0, 32,32,0,0, 32,33,0,0, 32,34,0,0, 32,35,0,0, ],36,28,0,1,46,35,3,14),
	RConstraints.R1(Edge_Net_Subnet2,[42,1,0,0, 42,2,0,0, 42,3,0,0, 42,4,0,0, ],4,28,0,1,46,35,3,14),
	).to_cnf()
Net2_Subnet14_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet2,Edge,Edge_Net,[32,0,0, 32,1,0, 32,2,0, 32,3,0, 32,4,0, 32,5,0, 32,6,0, 32,7,0, 32,8,0, 32,9,0, 32,10,0, 32,11,0, 32,12,0, 32,13,0, 32,14,0, 32,15,0, 32,16,0, 32,17,0, 32,18,0, 32,19,0, 32,20,0, 32,21,0, 32,22,0, 32,23,0, 32,24,0, 32,25,0, 32,26,0, 32,27,0, 32,28,0, 32,29,0, 32,30,0, 32,31,0, 32,32,0, 32,33,0, 32,34,0, 32,35,0, 42,1,0, 42,2,0, 42,3,0, 42,4,0, 42,5,0, ],41,28,0,0,46,35,3,14,1),
	)
Net2_Subnet14_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(0,0+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(2,2+1)])for x in range(28,46+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)])	).to_cnf()
...
# Net = 2 Subnet = 15 | Left -> Right [38,46] Top -> Bottom [0,35]
# Range R1(42,42,1,4)
# Range R2(42,42,30,33)
### Disable edges outside window
Edge_Net_Subnet2[0:38,0:35+1,0:3+1,0:2+1,0:2+1,15]=exprzeros(49248)
Edge_Net_Subnet2[46:69+1,0:35+1,0:3+1,0:2+1,0:2+1,15]=exprzeros(31104)

### Consistency Constraints
Net2_Subnet15_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,1]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet15_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet2[x,y,z,trend,mask,15]), Edge_Net[x,y,z,trend,mask,1])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet15_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,2,trend,0,15],Xor(Edge_Net_Subnet2[x,y,2,trend,1,15],Edge_Net_Subnet2[x,y,2,trend,2,15])),And(~Edge_Net_Subnet2[x,y,2,trend,0,15],~Edge_Net_Subnet2[x,y,2,trend,1,15],~Edge_Net_Subnet2[x,y,2,trend,2,15]))for x in range(38,46+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet15_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,3,1,0,15],Xor(Edge_Net_Subnet2[x,y,3,1,1,15],Edge_Net_Subnet2[x,y,3,1,2,15])),And(~Edge_Net_Subnet2[x,y,3,1,0,15],~Edge_Net_Subnet2[x,y,3,1,1,15],~Edge_Net_Subnet2[x,y,3,1,2,15]))for x in range(38,46+1)])for y in range(0,35+1)]).to_cnf()
Net2_Subnet15_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,1,trend,2,15],Xor(Edge_Net_Subnet2[x,y,1,trend,0,15],Edge_Net_Subnet2[x,y,1,trend,1,15])),And(~Edge_Net_Subnet2[x,y,1,trend,2,15],~Edge_Net_Subnet2[x,y,1,trend,0,15],~Edge_Net_Subnet2[x,y,1,trend,1,15]))for x in range(38,46+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet15_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,15], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(0,15)]))for trend in range(0,1+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,15], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(15+1,19)]))for trend in range(0,1+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,15], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(0,15)]))for trend in range(0,1+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,15], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(15+1,19)]))for trend in range(0,1+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net2_Subnet15_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,15], ~Edge_Net_Subnet2[x-1,y,1,1,1,15]), And(Edge_Net_Subnet2[x+1,y,1,1,1,15], Edge_Net_Subnet2[x+2,y,1,1,1,15], Edge_Net_Subnet2[x+3,y,1,1,1,15], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,15], ~Edge_Net_Subnet2[x+1,y,1,1,1,15]), And(Edge_Net_Subnet2[x-1,y,1,1,1,15], Edge_Net_Subnet2[x-2,y,1,1,1,15], Edge_Net_Subnet2[x-3,y,1,1,1,15], ))for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,15], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,15], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,15], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(38,46+1)])for y in range(0,32+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,15], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(38,46+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15]), And(Edge_Net_Subnet2[x,y+1,1,0,0,15], Edge_Net_Subnet2[x,y+2,1,0,0,15], Edge_Net_Subnet2[x,y+3,1,0,0,15], ))for x in range(38,46+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15]), And(Edge_Net_Subnet2[x,y-1,1,0,0,15], Edge_Net_Subnet2[x,y-2,1,0,0,15], Edge_Net_Subnet2[x,y-3,1,0,0,15], ))for x in range(38,46+1)])for y in range(35,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge_Net_Subnet2[x,y-1,1,0,0,15]), And(Edge_Net_Subnet2[x,y+1,1,0,0,15], Edge_Net_Subnet2[x,y+2,1,0,0,15], Edge_Net_Subnet2[x,y+3,1,0,0,15], ))for x in range(38,46+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge_Net_Subnet2[x,y+1,1,0,0,15]), And(Edge_Net_Subnet2[x,y-1,1,0,0,15], Edge_Net_Subnet2[x,y-2,1,0,0,15], Edge_Net_Subnet2[x,y-3,1,0,0,15], ))for x in range(38,46+1)])for y in range(0+3,35-1+1)])
	).to_cnf()
Net2_Subnet15_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(38,46+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(38,46+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ))for x in range(38,46+1)])for y in range(35-1,35-1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+2,1,0,0], ~Edge[x,y+1,1,0,0], ))for x in range(38,46+1)])for y in range(35-2,35-2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(38,46+1)])for y in range(0+3,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,15], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(38,46+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net2_Subnet15_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,15], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,15], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	).to_cnf()
...
Net2_Subnet15_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,15], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,32+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,15], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,15], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,15], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,15], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(38,46+1)])for y in range(0,33+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,15], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(38,46+1)])for y in range(2,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,15], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,15], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,2,1,mask,15], ~Edge_Net_Subnet2[x+1,y,2,1,mask,15]), And(Edge_Net_Subnet2[x-1,y,2,1,mask,15], Edge_Net_Subnet2[x-2,y,2,1,mask,15], Edge_Net_Subnet2[x-3,y,2,1,mask,15], Edge_Net_Subnet2[x-4,y,2,1,mask,15], Edge_Net_Subnet2[x-5,y,2,1,mask,15], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,15], And(Edge_Net_Subnet2[x-1,y,2,1,mask,15], Edge_Net_Subnet2[x-2,y,2,1,mask,15], Edge_Net_Subnet2[x-3,y,2,1,mask,15], Edge_Net_Subnet2[x-4,y,2,1,mask,15], Edge_Net_Subnet2[x-5,y,2,1,mask,15], ))for mask in range(1,2+1)])for x in range(38,38+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,15], And(Edge_Net_Subnet2[x+1,y,2,1,mask,15], Edge_Net_Subnet2[x+2,y,2,1,mask,15], Edge_Net_Subnet2[x+3,y,2,1,mask,15], Edge_Net_Subnet2[x+4,y,2,1,mask,15], Edge_Net_Subnet2[x+5,y,2,1,mask,15], ))for mask in range(1,2+1)])for x in range(46-1,38)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,15], ~Edge_Net_Subnet2[x,y-1,2,0,mask,15]), And(Edge_Net_Subnet2[x,y+1,2,0,mask,15], Edge_Net_Subnet2[x,y+2,2,0,mask,15], Edge_Net_Subnet2[x,y+3,2,0,mask,15], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,15], ~Edge_Net_Subnet2[x,y+1,2,0,mask,15]), And(Edge_Net_Subnet2[x,y-1,2,0,mask,15], Edge_Net_Subnet2[x,y-2,2,0,mask,15], Edge_Net_Subnet2[x,y-3,2,0,mask,15], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0+3,35-1+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,15], And(Edge_Net_Subnet2[x,y+1,2,0,mask,15], Edge_Net_Subnet2[x,y+2,2,0,mask,15], Edge_Net_Subnet2[x,y+3,2,0,mask,15], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,15], And(Edge_Net_Subnet2[x,y-1,2,0,mask,15], Edge_Net_Subnet2[x,y-2,2,0,mask,15], Edge_Net_Subnet2[x,y-3,2,0,mask,15], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(35,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,15], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,15], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,15], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,15], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,15], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(38,46+1)])for y in range(2,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,15], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(38,46+1)])for y in range(0,35-2+1)]),
	).to_cnf()
Net2_Subnet15_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,15], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(4,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,15], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35-4+1)]),
	).to_cnf()
Net2_Subnet15_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,15], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(38,46+1)])for y in range(0,35-3+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,15], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(38,46+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,15], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35-4+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,15], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(4,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,15], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,15], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(38,46+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,15], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,15], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,46+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,15], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,15], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,15], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,15], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet15_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,15], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,15], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(2,35+1)]),
	).to_cnf()
Net2_Subnet15_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,15], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,15], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,46+1)])for y in range(2,35+1)]),
	).to_cnf()
...
Net2_Subnet15_R1 = And(
	RConstraints.R1(Edge_Net_Subnet2,[42,1,0,0, 42,2,0,0, 42,3,0,0, 42,4,0,0, ],4,38,0,1,46,35,3,15),
	RConstraints.R1(Edge_Net_Subnet2,[42,30,0,0, 42,31,0,0, 42,32,0,0, 42,33,0,0, ],4,38,0,1,46,35,3,15),
	).to_cnf()
Net2_Subnet15_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet2,Edge,Edge_Net,[42,1,0, 42,2,0, 42,3,0, 42,4,0, 42,5,0, 42,30,0, 42,31,0, 42,32,0, 42,33,0, 42,34,0, ],10,38,0,0,46,35,3,15,1),
	)
Net2_Subnet15_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(0,0+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(2,2+1)])for x in range(38,46+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)])	).to_cnf()
...
# Net = 2 Subnet = 16 | Left -> Right [38,50] Top -> Bottom [0,18]
# Range R1(42,42,1,4)
# Range R2(46,46,1,14)
### Disable edges outside window
Edge_Net_Subnet2[0:38,0:35+1,0:3+1,0:2+1,0:2+1,16]=exprzeros(49248)
Edge_Net_Subnet2[38:50,18:35+1,0:3+1,0:2+1,0:2+1,16]=exprzeros(7776)
Edge_Net_Subnet2[50:69+1,0:35+1,0:3+1,0:2+1,0:2+1,16]=exprzeros(25920)

### Consistency Constraints
Net2_Subnet16_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,1]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet16_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet2[x,y,z,trend,mask,16]), Edge_Net[x,y,z,trend,mask,1])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet16_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,2,trend,0,16],Xor(Edge_Net_Subnet2[x,y,2,trend,1,16],Edge_Net_Subnet2[x,y,2,trend,2,16])),And(~Edge_Net_Subnet2[x,y,2,trend,0,16],~Edge_Net_Subnet2[x,y,2,trend,1,16],~Edge_Net_Subnet2[x,y,2,trend,2,16]))for x in range(38,50+1)])for y in range(0,18+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet16_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,3,1,0,16],Xor(Edge_Net_Subnet2[x,y,3,1,1,16],Edge_Net_Subnet2[x,y,3,1,2,16])),And(~Edge_Net_Subnet2[x,y,3,1,0,16],~Edge_Net_Subnet2[x,y,3,1,1,16],~Edge_Net_Subnet2[x,y,3,1,2,16]))for x in range(38,50+1)])for y in range(0,18+1)]).to_cnf()
Net2_Subnet16_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,1,trend,2,16],Xor(Edge_Net_Subnet2[x,y,1,trend,0,16],Edge_Net_Subnet2[x,y,1,trend,1,16])),And(~Edge_Net_Subnet2[x,y,1,trend,2,16],~Edge_Net_Subnet2[x,y,1,trend,0,16],~Edge_Net_Subnet2[x,y,1,trend,1,16]))for x in range(38,50+1)])for y in range(0,18+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet16_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,16], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(0,16)]))for trend in range(0,1+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,16], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(16+1,19)]))for trend in range(0,1+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,16], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(0,16)]))for trend in range(0,1+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,16], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(16+1,19)]))for trend in range(0,1+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
).to_cnf()
Net2_Subnet16_C = And(Net2_Subnet16_C1, Net2_Subnet16_C2,Net2_Subnet16_C3_ME1_Mask,Net2_Subnet16_C4_MINT1_Mask,Net2_Subnet16_C5_AIL2GIL_Mask,Net2_Subnet16_C6,)
### Design Rules
Net2_Subnet16_DR_Trend = And(
...
Net2_Subnet16_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,16], ~Edge_Net_Subnet2[x-1,y,1,1,1,16]), And(Edge_Net_Subnet2[x+1,y,1,1,1,16], Edge_Net_Subnet2[x+2,y,1,1,1,16], Edge_Net_Subnet2[x+3,y,1,1,1,16], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,16], ~Edge_Net_Subnet2[x+1,y,1,1,1,16]), And(Edge_Net_Subnet2[x-1,y,1,1,1,16], Edge_Net_Subnet2[x-2,y,1,1,1,16], Edge_Net_Subnet2[x-3,y,1,1,1,16], ))for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,16], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,16], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,16], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,16], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(38,50+1)])for y in range(3,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,16]), And(Edge_Net_Subnet2[x,y+1,1,0,0,16], Edge_Net_Subnet2[x,y+2,1,0,0,16], Edge_Net_Subnet2[x,y+3,1,0,0,16], ))for x in range(38,50+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,16], ~Edge_Net_Subnet2[x,y-1,1,0,0,16]), And(Edge_Net_Subnet2[x,y+1,1,0,0,16], Edge_Net_Subnet2[x,y+2,1,0,0,16], Edge_Net_Subnet2[x,y+3,1,0,0,16], ))for x in range(38,50+1)])for y in range(0+1,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,16], ~Edge_Net_Subnet2[x,y+1,1,0,0,16]), And(Edge_Net_Subnet2[x,y-1,1,0,0,16], Edge_Net_Subnet2[x,y-2,1,0,0,16], Edge_Net_Subnet2[x,y-3,1,0,0,16], ))for x in range(38,50+1)])for y in range(0+3,18+1)])
	).to_cnf()
Net2_Subnet16_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,16], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(38,50+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,16], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(38,50+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,16], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(38,50+1)])for y in range(0+3,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,16], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(38,50+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net2_Subnet16_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,16], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,16], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_MINT1AB_HorMinWidth = And(
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,3,1,mask,16], ~Edge_Net_Subnet2[x-1,y,3,1,mask,16]), And(Edge_Net_Subnet2[x+1,y,3,1,mask,16], Edge_Net_Subnet2[x+2,y,3,1,mask,16], Edge_Net_Subnet2[x+3,y,3,1,mask,16], Edge_Net_Subnet2[x+4,y,3,1,mask,16], Edge_Net_Subnet2[x+5,y,3,1,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,3,1,mask,16], ~Edge_Net_Subnet2[x+1,y,3,1,mask,16]), And(Edge_Net_Subnet2[x-1,y,3,1,mask,16], Edge_Net_Subnet2[x-2,y,3,1,mask,16], Edge_Net_Subnet2[x-3,y,3,1,mask,16], Edge_Net_Subnet2[x-4,y,3,1,mask,16], Edge_Net_Subnet2[x-5,y,3,1,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,16], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,16], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(3,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,16], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,16], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,16], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,16], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(38,50+1)])for y in range(2,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,16], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,16], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_M1AB_MinWidth = And(
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,2,1,mask,16], ~Edge_Net_Subnet2[x-1,y,2,1,mask,16]), And(Edge_Net_Subnet2[x+1,y,2,1,mask,16], Edge_Net_Subnet2[x+2,y,2,1,mask,16], Edge_Net_Subnet2[x+3,y,2,1,mask,16], Edge_Net_Subnet2[x+4,y,2,1,mask,16], Edge_Net_Subnet2[x+5,y,2,1,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,2,1,mask,16], ~Edge_Net_Subnet2[x+1,y,2,1,mask,16]), And(Edge_Net_Subnet2[x-1,y,2,1,mask,16], Edge_Net_Subnet2[x-2,y,2,1,mask,16], Edge_Net_Subnet2[x-3,y,2,1,mask,16], Edge_Net_Subnet2[x-4,y,2,1,mask,16], Edge_Net_Subnet2[x-5,y,2,1,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,16], And(Edge_Net_Subnet2[x-1,y,2,1,mask,16], Edge_Net_Subnet2[x-2,y,2,1,mask,16], Edge_Net_Subnet2[x-3,y,2,1,mask,16], Edge_Net_Subnet2[x-4,y,2,1,mask,16], Edge_Net_Subnet2[x-5,y,2,1,mask,16], ))for mask in range(1,2+1)])for x in range(38,38+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,16], And(Edge_Net_Subnet2[x+1,y,2,1,mask,16], Edge_Net_Subnet2[x+2,y,2,1,mask,16], Edge_Net_Subnet2[x+3,y,2,1,mask,16], Edge_Net_Subnet2[x+4,y,2,1,mask,16], Edge_Net_Subnet2[x+5,y,2,1,mask,16], ))for mask in range(1,2+1)])for x in range(50-1,38)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,16], ~Edge_Net_Subnet2[x,y-1,2,0,mask,16]), And(Edge_Net_Subnet2[x,y+1,2,0,mask,16], Edge_Net_Subnet2[x,y+2,2,0,mask,16], Edge_Net_Subnet2[x,y+3,2,0,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0+1,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,16], ~Edge_Net_Subnet2[x,y+1,2,0,mask,16]), And(Edge_Net_Subnet2[x,y-1,2,0,mask,16], Edge_Net_Subnet2[x,y-2,2,0,mask,16], Edge_Net_Subnet2[x,y-3,2,0,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0+3,18+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,16], And(Edge_Net_Subnet2[x,y+1,2,0,mask,16], Edge_Net_Subnet2[x,y+2,2,0,mask,16], Edge_Net_Subnet2[x,y+3,2,0,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,16], And(Edge_Net_Subnet2[x,y-1,2,0,mask,16], Edge_Net_Subnet2[x,y-2,2,0,mask,16], Edge_Net_Subnet2[x,y-3,2,0,mask,16], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(18,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,16], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,16], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,16], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,16], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,16], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(38,50+1)])for y in range(2,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,16], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,16], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(4,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,16], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,16], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,16], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(38,50+1)])for y in range(3,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,16], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,16], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(4,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,16], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,16], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(38,50+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,16], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,16], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,16], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,16], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,16], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,16], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet16_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,16], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,16], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(2,18+1)]),
	).to_cnf()
Net2_Subnet16_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,16], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,16], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(38,50+1)])for y in range(2,18+1)]),
	).to_cnf()
Net2_Subnet16_DR = And(Net2_Subnet16_DR_Trend, Net2_Subnet16_DR_GIL_HorMinWidth,Net2_Subnet16_DR_GIL_HorMinSpacing,Net2_Subnet16_DR_GIL_VerMinSpacing,Net2_Subnet16_DR_AIL2_VerMinWidth,Net2_Subnet16_DR_AIL2_VerMinSpacing,Net2_Subnet16_DR_VerAIL2_HorMinSpacing,Net2_Subnet16_DR_MINT1AB_HorMinWidth,Net2_Subnet16_DR_MINT1_SameMask_VerMinSpacing,Net2_Subnet16_DR_MINT1_SameMask_HorMinSpacing,Net2_Subnet16_DR_MINT1_DiffMask_VerMinSpacing,Net2_Subnet16_DR_MINT1_DiffMask_HorMinSpacing,Net2_Subnet16_DR_M1AB_MinWidth,Net2_Subnet16_DR_HorM1_DiffMask_HorMinSpacing,Net2_Subnet16_DR_HorM1_SameMask_HorMinSpacing,Net2_Subnet16_DR_VerM1_DiffMask_VerMinSpacing,Net2_Subnet16_DR_VerM1_SameMask_VerMinSpacing,Net2_Subnet16_DR_HorM1_DiffMask_VerMinSpacing,Net2_Subnet16_DR_HorM1_SameMask_VerMinSpacing,Net2_Subnet16_DR_VerM1_DiffMask_HorMinSpacing,Net2_Subnet16_DR_VerM1_SameMask_HorMinSpacing,Net2_Subnet16_DR_V0_HorMinSpacing,Net2_Subnet16_DR_V1_HorMinSpacing,Net2_Subnet16_DR_V0_VerMinSpacing,Net2_Subnet16_DR_V1_VerMinSpacing,)
### Routability Constraints
Net2_Subnet16_R1 = And(
	RConstraints.R1(Edge_Net_Subnet2,[42,1,0,0, 42,2,0,0, 42,3,0,0, 42,4,0,0, ],4,38,0,1,50,18,3,16),
	RConstraints.R1(Edge_Net_Subnet2,[46,1,0,0, 46,2,0,0, 46,3,0,0, 46,4,0,0, 46,5,0,0, 46,6,0,0, 46,7,0,0, 46,8,0,0, 46,9,0,0, 46,10,0,0, 46,11,0,0, 46,12,0,0, 46,13,0,0, 46,14,0,0, ],14,38,0,1,50,18,3,16),
	).to_cnf()
Net2_Subnet16_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet2,Edge,Edge_Net,[42,1,0, 42,2,0, 42,3,0, 42,4,0, 42,5,0, 46,1,0, 46,2,0, 46,3,0, 46,4,0, 46,5,0, 46,6,0, 46,7,0, 46,8,0, 46,9,0, 46,10,0, 46,11,0, 46,12,0, 46,13,0, 46,14,0, 46,15,0, ],20,38,0,0,50,18,3,16,1),
	)
Net2_Subnet16_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(0,0+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(2,2+1)])for x in range(38,50+1)])for y in range(0,18+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)])	).to_cnf()
Net2_Subnet16_R = And(Net2_Subnet16_R1,Net2_Subnet16_R2,Net2_Subnet16_R3,)
Net2_Subnet16_Formula = And(Net2_Subnet16_C,Net2_Subnet16_DR,Net2_Subnet16_R)
# Net = 2 Subnet = 17 | Left -> Right [42,50] Top -> Bottom [0,35]
# Range R1(46,46,1,14)
# Range R2(46,46,20,33)
### Disable edges outside window
Edge_Net_Subnet2[0:42,0:35+1,0:3+1,0:2+1,0:2+1,17]=exprzeros(54432)
Edge_Net_Subnet2[50:69+1,0:35+1,0:3+1,0:2+1,0:2+1,17]=exprzeros(25920)

### Consistency Constraints
Net2_Subnet17_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,1]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet17_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet2[x,y,z,trend,mask,17]), Edge_Net[x,y,z,trend,mask,1])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet17_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,2,trend,0,17],Xor(Edge_Net_Subnet2[x,y,2,trend,1,17],Edge_Net_Subnet2[x,y,2,trend,2,17])),And(~Edge_Net_Subnet2[x,y,2,trend,0,17],~Edge_Net_Subnet2[x,y,2,trend,1,17],~Edge_Net_Subnet2[x,y,2,trend,2,17]))for x in range(42,50+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet17_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,3,1,0,17],Xor(Edge_Net_Subnet2[x,y,3,1,1,17],Edge_Net_Subnet2[x,y,3,1,2,17])),And(~Edge_Net_Subnet2[x,y,3,1,0,17],~Edge_Net_Subnet2[x,y,3,1,1,17],~Edge_Net_Subnet2[x,y,3,1,2,17]))for x in range(42,50+1)])for y in range(0,35+1)]).to_cnf()
Net2_Subnet17_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,1,trend,2,17],Xor(Edge_Net_Subnet2[x,y,1,trend,0,17],Edge_Net_Subnet2[x,y,1,trend,1,17])),And(~Edge_Net_Subnet2[x,y,1,trend,2,17],~Edge_Net_Subnet2[x,y,1,trend,0,17],~Edge_Net_Subnet2[x,y,1,trend,1,17]))for x in range(42,50+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet17_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,17], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(0,17)]))for trend in range(0,1+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,17], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(17+1,19)]))for trend in range(0,1+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,17], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(0,17)]))for trend in range(0,1+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,17], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(17+1,19)]))for trend in range(0,1+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net2_Subnet17_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,17], ~Edge_Net_Subnet2[x-1,y,1,1,1,17]), And(Edge_Net_Subnet2[x+1,y,1,1,1,17], Edge_Net_Subnet2[x+2,y,1,1,1,17], Edge_Net_Subnet2[x+3,y,1,1,1,17], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,17], ~Edge_Net_Subnet2[x+1,y,1,1,1,17]), And(Edge_Net_Subnet2[x-1,y,1,1,1,17], Edge_Net_Subnet2[x-2,y,1,1,1,17], Edge_Net_Subnet2[x-3,y,1,1,1,17], ))for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,17], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,17], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,17], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(42,50+1)])for y in range(0,32+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,17], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(42,50+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17]), And(Edge_Net_Subnet2[x,y+1,1,0,0,17], Edge_Net_Subnet2[x,y+2,1,0,0,17], Edge_Net_Subnet2[x,y+3,1,0,0,17], ))for x in range(42,50+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17]), And(Edge_Net_Subnet2[x,y-1,1,0,0,17], Edge_Net_Subnet2[x,y-2,1,0,0,17], Edge_Net_Subnet2[x,y-3,1,0,0,17], ))for x in range(42,50+1)])for y in range(35,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge_Net_Subnet2[x,y-1,1,0,0,17]), And(Edge_Net_Subnet2[x,y+1,1,0,0,17], Edge_Net_Subnet2[x,y+2,1,0,0,17], Edge_Net_Subnet2[x,y+3,1,0,0,17], ))for x in range(42,50+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge_Net_Subnet2[x,y+1,1,0,0,17]), And(Edge_Net_Subnet2[x,y-1,1,0,0,17], Edge_Net_Subnet2[x,y-2,1,0,0,17], Edge_Net_Subnet2[x,y-3,1,0,0,17], ))for x in range(42,50+1)])for y in range(0+3,35-1+1)])
	).to_cnf()
Net2_Subnet17_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(42,50+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(42,50+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ))for x in range(42,50+1)])for y in range(35-1,35-1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+2,1,0,0], ~Edge[x,y+1,1,0,0], ))for x in range(42,50+1)])for y in range(35-2,35-2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(42,50+1)])for y in range(0+3,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,17], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(42,50+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net2_Subnet17_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,17], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,17], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	).to_cnf()
...
Net2_Subnet17_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,17], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,32+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,17], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,17], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,17], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,17], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(42,50+1)])for y in range(0,33+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,17], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(42,50+1)])for y in range(2,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,17], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,17], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,2,1,mask,17], ~Edge_Net_Subnet2[x+1,y,2,1,mask,17]), And(Edge_Net_Subnet2[x-1,y,2,1,mask,17], Edge_Net_Subnet2[x-2,y,2,1,mask,17], Edge_Net_Subnet2[x-3,y,2,1,mask,17], Edge_Net_Subnet2[x-4,y,2,1,mask,17], Edge_Net_Subnet2[x-5,y,2,1,mask,17], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,17], And(Edge_Net_Subnet2[x-1,y,2,1,mask,17], Edge_Net_Subnet2[x-2,y,2,1,mask,17], Edge_Net_Subnet2[x-3,y,2,1,mask,17], Edge_Net_Subnet2[x-4,y,2,1,mask,17], Edge_Net_Subnet2[x-5,y,2,1,mask,17], ))for mask in range(1,2+1)])for x in range(42,42+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,17], And(Edge_Net_Subnet2[x+1,y,2,1,mask,17], Edge_Net_Subnet2[x+2,y,2,1,mask,17], Edge_Net_Subnet2[x+3,y,2,1,mask,17], Edge_Net_Subnet2[x+4,y,2,1,mask,17], Edge_Net_Subnet2[x+5,y,2,1,mask,17], ))for mask in range(1,2+1)])for x in range(50-1,42)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,17], ~Edge_Net_Subnet2[x,y-1,2,0,mask,17]), And(Edge_Net_Subnet2[x,y+1,2,0,mask,17], Edge_Net_Subnet2[x,y+2,2,0,mask,17], Edge_Net_Subnet2[x,y+3,2,0,mask,17], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,17], ~Edge_Net_Subnet2[x,y+1,2,0,mask,17]), And(Edge_Net_Subnet2[x,y-1,2,0,mask,17], Edge_Net_Subnet2[x,y-2,2,0,mask,17], Edge_Net_Subnet2[x,y-3,2,0,mask,17], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0+3,35-1+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,17], And(Edge_Net_Subnet2[x,y+1,2,0,mask,17], Edge_Net_Subnet2[x,y+2,2,0,mask,17], Edge_Net_Subnet2[x,y+3,2,0,mask,17], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,17], And(Edge_Net_Subnet2[x,y-1,2,0,mask,17], Edge_Net_Subnet2[x,y-2,2,0,mask,17], Edge_Net_Subnet2[x,y-3,2,0,mask,17], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(35,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,17], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,17], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,17], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,17], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,17], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(42,50+1)])for y in range(2,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,17], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(42,50+1)])for y in range(0,35-2+1)]),
	).to_cnf()
Net2_Subnet17_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,17], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(4,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,17], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35-4+1)]),
	).to_cnf()
Net2_Subnet17_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,17], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(42,50+1)])for y in range(0,35-3+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,17], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(42,50+1)])for y in range(3,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,17], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35-4+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,17], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(4,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,17], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,17], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(42,50+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,17], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,17], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,50+1)])for y in range(0,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,17], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,17], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,17], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,17], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(0,35+1)])
	).to_cnf()
Net2_Subnet17_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,17], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,17], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(2,35+1)]),
	).to_cnf()
Net2_Subnet17_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,17], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,17], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,50+1)])for y in range(2,35+1)]),
	).to_cnf()
...
Net2_Subnet17_R1 = And(
	RConstraints.R1(Edge_Net_Subnet2,[46,1,0,0, 46,2,0,0, 46,3,0,0, 46,4,0,0, 46,5,0,0, 46,6,0,0, 46,7,0,0, 46,8,0,0, 46,9,0,0, 46,10,0,0, 46,11,0,0, 46,12,0,0, 46,13,0,0, 46,14,0,0, ],14,42,0,1,50,35,3,17),
	RConstraints.R1(Edge_Net_Subnet2,[46,20,0,0, 46,21,0,0, 46,22,0,0, 46,23,0,0, 46,24,0,0, 46,25,0,0, 46,26,0,0, 46,27,0,0, 46,28,0,0, 46,29,0,0, 46,30,0,0, 46,31,0,0, 46,32,0,0, 46,33,0,0, ],14,42,0,1,50,35,3,17),
	).to_cnf()
Net2_Subnet17_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet2,Edge,Edge_Net,[46,1,0, 46,2,0, 46,3,0, 46,4,0, 46,5,0, 46,6,0, 46,7,0, 46,8,0, 46,9,0, 46,10,0, 46,11,0, 46,12,0, 46,13,0, 46,14,0, 46,15,0, 46,20,0, 46,21,0, 46,22,0, 46,23,0, 46,24,0, 46,25,0, 46,26,0, 46,27,0, 46,28,0, 46,29,0, 46,30,0, 46,31,0, 46,32,0, 46,33,0, 46,34,0, ],30,42,0,0,50,35,3,17,1),
	)
Net2_Subnet17_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(0,0+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(2,2+1)])for x in range(42,50+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)])	).to_cnf()
...
# Net = 2 Subnet = 18 | Left -> Right [42,58] Top -> Bottom [0,18]
# Range R1(46,46,1,14)
# Range R2(54,54,1,14)
### Disable edges outside window
Edge_Net_Subnet2[0:42,0:35+1,0:3+1,0:2+1,0:2+1,18]=exprzeros(54432)
Edge_Net_Subnet2[42:58,18:35+1,0:3+1,0:2+1,0:2+1,18]=exprzeros(10368)
Edge_Net_Subnet2[58:69+1,0:35+1,0:3+1,0:2+1,0:2+1,18]=exprzeros(15552)

### Consistency Constraints
Net2_Subnet18_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,1]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(42,58+1)])for y in range(0,18+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet18_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet2[x,y,z,trend,mask,18]), Edge_Net[x,y,z,trend,mask,1])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(42,58+1)])for y in range(0,18+1)])for z in range(0,3+1)]).to_cnf()
Net2_Subnet18_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,2,trend,0,18],Xor(Edge_Net_Subnet2[x,y,2,trend,1,18],Edge_Net_Subnet2[x,y,2,trend,2,18])),And(~Edge_Net_Subnet2[x,y,2,trend,0,18],~Edge_Net_Subnet2[x,y,2,trend,1,18],~Edge_Net_Subnet2[x,y,2,trend,2,18]))for x in range(42,58+1)])for y in range(0,18+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet18_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,3,1,0,18],Xor(Edge_Net_Subnet2[x,y,3,1,1,18],Edge_Net_Subnet2[x,y,3,1,2,18])),And(~Edge_Net_Subnet2[x,y,3,1,0,18],~Edge_Net_Subnet2[x,y,3,1,1,18],~Edge_Net_Subnet2[x,y,3,1,2,18]))for x in range(42,58+1)])for y in range(0,18+1)]).to_cnf()
Net2_Subnet18_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet2[x,y,1,trend,2,18],Xor(Edge_Net_Subnet2[x,y,1,trend,0,18],Edge_Net_Subnet2[x,y,1,trend,1,18])),And(~Edge_Net_Subnet2[x,y,1,trend,2,18],~Edge_Net_Subnet2[x,y,1,trend,0,18],~Edge_Net_Subnet2[x,y,1,trend,1,18]))for x in range(42,58+1)])for y in range(0,18+1)])for trend in range(0,1+1)]).to_cnf()
Net2_Subnet18_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,1,18], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,2,s2])for s2 in range(0,18)]))for trend in range(0,1+1)])for x in range(42,58+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,z,trend,2,18], And(*[And(~Edge_Net_Subnet2[x,y,z,trend,1,s2])for s2 in range(0,18)]))for trend in range(0,1+1)])for x in range(42,58+1)])for y in range(0,18+1)])for z in range(2,3+1)]),
).to_cnf()
Net2_Subnet18_C = And(Net2_Subnet18_C1, Net2_Subnet18_C2,Net2_Subnet18_C3_ME1_Mask,Net2_Subnet18_C4_MINT1_Mask,Net2_Subnet18_C5_AIL2GIL_Mask,Net2_Subnet18_C6,)
### Design Rules
Net2_Subnet18_DR_Trend = And(
...
Net2_Subnet18_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,18], ~Edge_Net_Subnet2[x-1,y,1,1,1,18]), And(Edge_Net_Subnet2[x+1,y,1,1,1,18], Edge_Net_Subnet2[x+2,y,1,1,1,18], Edge_Net_Subnet2[x+3,y,1,1,1,18], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,1,1,1,18], ~Edge_Net_Subnet2[x+1,y,1,1,1,18]), And(Edge_Net_Subnet2[x-1,y,1,1,1,18], Edge_Net_Subnet2[x-2,y,1,1,1,18], Edge_Net_Subnet2[x-3,y,1,1,1,18], ))for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,18], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,1,1,18], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,18], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,1,1,18], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(42,58+1)])for y in range(3,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,18]), And(Edge_Net_Subnet2[x,y+1,1,0,0,18], Edge_Net_Subnet2[x,y+2,1,0,0,18], Edge_Net_Subnet2[x,y+3,1,0,0,18], ))for x in range(42,58+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,18], ~Edge_Net_Subnet2[x,y-1,1,0,0,18]), And(Edge_Net_Subnet2[x,y+1,1,0,0,18], Edge_Net_Subnet2[x,y+2,1,0,0,18], Edge_Net_Subnet2[x,y+3,1,0,0,18], ))for x in range(42,58+1)])for y in range(0+1,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,18], ~Edge_Net_Subnet2[x,y+1,1,0,0,18]), And(Edge_Net_Subnet2[x,y-1,1,0,0,18], Edge_Net_Subnet2[x,y-2,1,0,0,18], Edge_Net_Subnet2[x,y-3,1,0,0,18], ))for x in range(42,58+1)])for y in range(0+3,18+1)])
	).to_cnf()
Net2_Subnet18_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,18], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(42,58+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,18], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(42,58+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,18], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(42,58+1)])for y in range(0+3,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,1,0,0,18], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(42,58+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net2_Subnet18_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,18], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,0,0,18], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_MINT1AB_HorMinWidth = And(
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,3,1,mask,18], ~Edge_Net_Subnet2[x-1,y,3,1,mask,18]), And(Edge_Net_Subnet2[x+1,y,3,1,mask,18], Edge_Net_Subnet2[x+2,y,3,1,mask,18], Edge_Net_Subnet2[x+3,y,3,1,mask,18], Edge_Net_Subnet2[x+4,y,3,1,mask,18], Edge_Net_Subnet2[x+5,y,3,1,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,3,1,mask,18], ~Edge_Net_Subnet2[x+1,y,3,1,mask,18]), And(Edge_Net_Subnet2[x-1,y,3,1,mask,18], Edge_Net_Subnet2[x-2,y,3,1,mask,18], Edge_Net_Subnet2[x-3,y,3,1,mask,18], Edge_Net_Subnet2[x-4,y,3,1,mask,18], Edge_Net_Subnet2[x-5,y,3,1,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,18], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,mask,18], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(3,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,18], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,mask,18], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,18], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,3,1,1,18], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(42,58+1)])for y in range(2,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,18], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,3,1,1,18], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_M1AB_MinWidth = And(
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,2,1,mask,18], ~Edge_Net_Subnet2[x-1,y,2,1,mask,18]), And(Edge_Net_Subnet2[x+1,y,2,1,mask,18], Edge_Net_Subnet2[x+2,y,2,1,mask,18], Edge_Net_Subnet2[x+3,y,2,1,mask,18], Edge_Net_Subnet2[x+4,y,2,1,mask,18], Edge_Net_Subnet2[x+5,y,2,1,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet2[x,y,2,1,mask,18], ~Edge_Net_Subnet2[x+1,y,2,1,mask,18]), And(Edge_Net_Subnet2[x-1,y,2,1,mask,18], Edge_Net_Subnet2[x-2,y,2,1,mask,18], Edge_Net_Subnet2[x-3,y,2,1,mask,18], Edge_Net_Subnet2[x-4,y,2,1,mask,18], Edge_Net_Subnet2[x-5,y,2,1,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,18], And(Edge_Net_Subnet2[x-1,y,2,1,mask,18], Edge_Net_Subnet2[x-2,y,2,1,mask,18], Edge_Net_Subnet2[x-3,y,2,1,mask,18], Edge_Net_Subnet2[x-4,y,2,1,mask,18], Edge_Net_Subnet2[x-5,y,2,1,mask,18], ))for mask in range(1,2+1)])for x in range(42,42+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,18], And(Edge_Net_Subnet2[x+1,y,2,1,mask,18], Edge_Net_Subnet2[x+2,y,2,1,mask,18], Edge_Net_Subnet2[x+3,y,2,1,mask,18], Edge_Net_Subnet2[x+4,y,2,1,mask,18], Edge_Net_Subnet2[x+5,y,2,1,mask,18], ))for mask in range(1,2+1)])for x in range(58-1,42)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,18], ~Edge_Net_Subnet2[x,y-1,2,0,mask,18]), And(Edge_Net_Subnet2[x,y+1,2,0,mask,18], Edge_Net_Subnet2[x,y+2,2,0,mask,18], Edge_Net_Subnet2[x,y+3,2,0,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0+1,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,18], ~Edge_Net_Subnet2[x,y+1,2,0,mask,18]), And(Edge_Net_Subnet2[x,y-1,2,0,mask,18], Edge_Net_Subnet2[x,y-2,2,0,mask,18], Edge_Net_Subnet2[x,y-3,2,0,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0+3,18+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,18], And(Edge_Net_Subnet2[x,y+1,2,0,mask,18], Edge_Net_Subnet2[x,y+2,2,0,mask,18], Edge_Net_Subnet2[x,y+3,2,0,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet2[x,y,2,0,mask,18], And(Edge_Net_Subnet2[x,y-1,2,0,mask,18], Edge_Net_Subnet2[x,y-2,2,0,mask,18], Edge_Net_Subnet2[x,y-3,2,0,mask,18], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(18,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,18], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,1,18], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,18], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,1,mask,18], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,18], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(42,58+1)])for y in range(2,18+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,1,18], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,18], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(4,18+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet2[x,y,2,0,mask,18], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,18], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,1,18], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(42,58+1)])for y in range(3,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,18], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,1,mask,18], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(4,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,18], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,1,18], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(42,58+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,18], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,0,mask,18], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,18], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,1,2,mask,18], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,18], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet2[x,y,2,2,mask,18], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(0,18+1)])
	).to_cnf()
Net2_Subnet18_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,18], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,1,2,mask,18], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(2,18+1)]),
	).to_cnf()
Net2_Subnet18_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,18], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(0,18+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet2[x,y,2,2,mask,18], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(42,58+1)])for y in range(2,18+1)]),
	).to_cnf()
Net2_Subnet18_DR = And(Net2_Subnet18_DR_Trend, Net2_Subnet18_DR_GIL_HorMinWidth,Net2_Subnet18_DR_GIL_HorMinSpacing,Net2_Subnet18_DR_GIL_VerMinSpacing,Net2_Subnet18_DR_AIL2_VerMinWidth,Net2_Subnet18_DR_AIL2_VerMinSpacing,Net2_Subnet18_DR_VerAIL2_HorMinSpacing,Net2_Subnet18_DR_MINT1AB_HorMinWidth,Net2_Subnet18_DR_MINT1_SameMask_VerMinSpacing,Net2_Subnet18_DR_MINT1_SameMask_HorMinSpacing,Net2_Subnet18_DR_MINT1_DiffMask_VerMinSpacing,Net2_Subnet18_DR_MINT1_DiffMask_HorMinSpacing,Net2_Subnet18_DR_M1AB_MinWidth,Net2_Subnet18_DR_HorM1_DiffMask_HorMinSpacing,Net2_Subnet18_DR_HorM1_SameMask_HorMinSpacing,Net2_Subnet18_DR_VerM1_DiffMask_VerMinSpacing,Net2_Subnet18_DR_VerM1_SameMask_VerMinSpacing,Net2_Subnet18_DR_HorM1_DiffMask_VerMinSpacing,Net2_Subnet18_DR_HorM1_SameMask_VerMinSpacing,Net2_Subnet18_DR_VerM1_DiffMask_HorMinSpacing,Net2_Subnet18_DR_VerM1_SameMask_HorMinSpacing,Net2_Subnet18_DR_V0_HorMinSpacing,Net2_Subnet18_DR_V1_HorMinSpacing,Net2_Subnet18_DR_V0_VerMinSpacing,Net2_Subnet18_DR_V1_VerMinSpacing,)
### Routability Constraints
Net2_Subnet18_R1 = And(
	RConstraints.R1(Edge_Net_Subnet2,[46,1,0,0, 46,2,0,0, 46,3,0,0, 46,4,0,0, 46,5,0,0, 46,6,0,0, 46,7,0,0, 46,8,0,0, 46,9,0,0, 46,10,0,0, 46,11,0,0, 46,12,0,0, 46,13,0,0, 46,14,0,0, ],14,42,0,1,58,18,3,18),
	RConstraints.R1(Edge_Net_Subnet2,[54,1,0,0, 54,2,0,0, 54,3,0,0, 54,4,0,0, 54,5,0,0, 54,6,0,0, 54,7,0,0, 54,8,0,0, 54,9,0,0, 54,10,0,0, 54,11,0,0, 54,12,0,0, 54,13,0,0, 54,14,0,0, ],14,42,0,1,58,18,3,18),
	).to_cnf()
Net2_Subnet18_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet2,Edge,Edge_Net,[46,1,0, 46,2,0, 46,3,0, 46,4,0, 46,5,0, 46,6,0, 46,7,0, 46,8,0, 46,9,0, 46,10,0, 46,11,0, 46,12,0, 46,13,0, 46,14,0, 46,15,0, 54,1,0, 54,2,0, 54,3,0, 54,4,0, 54,5,0, 54,6,0, 54,7,0, 54,8,0, 54,9,0, 54,10,0, 54,11,0, 54,12,0, 54,13,0, 54,14,0, 54,15,0, ],30,42,0,0,58,18,3,18,1),
	)
Net2_Subnet18_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(0,0+1)])for x in range(42,58+1)])for y in range(0,18+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,1],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(2,2+1)])for x in range(42,58+1)])for y in range(0,18+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)])	).to_cnf()
Net2_Subnet18_R = And(Net2_Subnet18_R1,Net2_Subnet18_R2,Net2_Subnet18_R3,)
Net2_Subnet18_Formula = And(Net2_Subnet18_C,Net2_Subnet18_DR,Net2_Subnet18_R)
# Net = 3 Subnet = 1 | Left -> Right [36,52] Top -> Bottom [0,35]
# Range R1(40,40,0,35)
# Range R2(48,48,0,35)
### Disable edges outside window
Edge_Net_Subnet3[0:36,0:35+1,0:3+1,0:2+1,0:2+1,1]=exprzeros(46656)
Edge_Net_Subnet3[52:69+1,0:35+1,0:3+1,0:2+1,0:2+1,1]=exprzeros(23328)

### Consistency Constraints
Net3_Subnet1_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,2]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(36,52+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net3_Subnet1_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet3[x,y,z,trend,mask,1]), Edge_Net[x,y,z,trend,mask,2])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(36,52+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net3_Subnet1_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,2,trend,0,1],Xor(Edge_Net_Subnet3[x,y,2,trend,1,1],Edge_Net_Subnet3[x,y,2,trend,2,1])),And(~Edge_Net_Subnet3[x,y,2,trend,0,1],~Edge_Net_Subnet3[x,y,2,trend,1,1],~Edge_Net_Subnet3[x,y,2,trend,2,1]))for x in range(36,52+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net3_Subnet1_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,3,1,0,1],Xor(Edge_Net_Subnet3[x,y,3,1,1,1],Edge_Net_Subnet3[x,y,3,1,2,1])),And(~Edge_Net_Subnet3[x,y,3,1,0,1],~Edge_Net_Subnet3[x,y,3,1,1,1],~Edge_Net_Subnet3[x,y,3,1,2,1]))for x in range(36,52+1)])for y in range(0,35+1)]).to_cnf()
Net3_Subnet1_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,1,trend,2,1],Xor(Edge_Net_Subnet3[x,y,1,trend,0,1],Edge_Net_Subnet3[x,y,1,trend,1,1])),And(~Edge_Net_Subnet3[x,y,1,trend,2,1],~Edge_Net_Subnet3[x,y,1,trend,0,1],~Edge_Net_Subnet3[x,y,1,trend,1,1]))for x in range(36,52+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net3_Subnet1_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,1,1], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,2,s2])for s2 in range(0,1)]))for trend in range(0,1+1)])for x in range(36,52+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,1,1], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,2,s2])for s2 in range(1+1,7)]))for trend in range(0,1+1)])for x in range(36,52+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,2,1], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,1,s2])for s2 in range(0,1)]))for trend in range(0,1+1)])for x in range(36,52+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,2,1], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,1,s2])for s2 in range(1+1,7)]))for trend in range(0,1+1)])for x in range(36,52+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net3_Subnet1_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,1,1,1,1], ~Edge_Net_Subnet3[x-1,y,1,1,1,1]), And(Edge_Net_Subnet3[x+1,y,1,1,1,1], Edge_Net_Subnet3[x+2,y,1,1,1,1], Edge_Net_Subnet3[x+3,y,1,1,1,1], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,1,1,1,1], ~Edge_Net_Subnet3[x+1,y,1,1,1,1]), And(Edge_Net_Subnet3[x-1,y,1,1,1,1], Edge_Net_Subnet3[x-2,y,1,1,1,1], Edge_Net_Subnet3[x-3,y,1,1,1,1], ))for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,1,1,1], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,1,1,1], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,1,1,1], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(36,52+1)])for y in range(0,32+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,1,1,1], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(36,52+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1]), And(Edge_Net_Subnet3[x,y+1,1,0,0,1], Edge_Net_Subnet3[x,y+2,1,0,0,1], Edge_Net_Subnet3[x,y+3,1,0,0,1], ))for x in range(36,52+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1]), And(Edge_Net_Subnet3[x,y-1,1,0,0,1], Edge_Net_Subnet3[x,y-2,1,0,0,1], Edge_Net_Subnet3[x,y-3,1,0,0,1], ))for x in range(36,52+1)])for y in range(35,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge_Net_Subnet3[x,y-1,1,0,0,1]), And(Edge_Net_Subnet3[x,y+1,1,0,0,1], Edge_Net_Subnet3[x,y+2,1,0,0,1], Edge_Net_Subnet3[x,y+3,1,0,0,1], ))for x in range(36,52+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge_Net_Subnet3[x,y+1,1,0,0,1]), And(Edge_Net_Subnet3[x,y-1,1,0,0,1], Edge_Net_Subnet3[x,y-2,1,0,0,1], Edge_Net_Subnet3[x,y-3,1,0,0,1], ))for x in range(36,52+1)])for y in range(0+3,35-1+1)])
	).to_cnf()
Net3_Subnet1_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(36,52+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(36,52+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ))for x in range(36,52+1)])for y in range(35-1,35-1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+2,1,0,0], ~Edge[x,y+1,1,0,0], ))for x in range(36,52+1)])for y in range(35-2,35-2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(36,52+1)])for y in range(0+3,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,1], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(36,52+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net3_Subnet1_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,0,0,1], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,0,0,1], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	).to_cnf()
...
Net3_Subnet1_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,mask,1], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,32+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,mask,1], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,mask,1], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,mask,1], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,1,1], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(36,52+1)])for y in range(0,33+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,1,1], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(36,52+1)])for y in range(2,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,1,1], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,1,1], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,2,1,mask,1], ~Edge_Net_Subnet3[x+1,y,2,1,mask,1]), And(Edge_Net_Subnet3[x-1,y,2,1,mask,1], Edge_Net_Subnet3[x-2,y,2,1,mask,1], Edge_Net_Subnet3[x-3,y,2,1,mask,1], Edge_Net_Subnet3[x-4,y,2,1,mask,1], Edge_Net_Subnet3[x-5,y,2,1,mask,1], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,1], And(Edge_Net_Subnet3[x-1,y,2,1,mask,1], Edge_Net_Subnet3[x-2,y,2,1,mask,1], Edge_Net_Subnet3[x-3,y,2,1,mask,1], Edge_Net_Subnet3[x-4,y,2,1,mask,1], Edge_Net_Subnet3[x-5,y,2,1,mask,1], ))for mask in range(1,2+1)])for x in range(36,36+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,1], And(Edge_Net_Subnet3[x+1,y,2,1,mask,1], Edge_Net_Subnet3[x+2,y,2,1,mask,1], Edge_Net_Subnet3[x+3,y,2,1,mask,1], Edge_Net_Subnet3[x+4,y,2,1,mask,1], Edge_Net_Subnet3[x+5,y,2,1,mask,1], ))for mask in range(1,2+1)])for x in range(52-1,36)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,1], ~Edge_Net_Subnet3[x,y-1,2,0,mask,1]), And(Edge_Net_Subnet3[x,y+1,2,0,mask,1], Edge_Net_Subnet3[x,y+2,2,0,mask,1], Edge_Net_Subnet3[x,y+3,2,0,mask,1], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,1], ~Edge_Net_Subnet3[x,y+1,2,0,mask,1]), And(Edge_Net_Subnet3[x,y-1,2,0,mask,1], Edge_Net_Subnet3[x,y-2,2,0,mask,1], Edge_Net_Subnet3[x,y-3,2,0,mask,1], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0+3,35-1+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet3[x,y,2,0,mask,1], And(Edge_Net_Subnet3[x,y+1,2,0,mask,1], Edge_Net_Subnet3[x,y+2,2,0,mask,1], Edge_Net_Subnet3[x,y+3,2,0,mask,1], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet3[x,y,2,0,mask,1], And(Edge_Net_Subnet3[x,y-1,2,0,mask,1], Edge_Net_Subnet3[x,y-2,2,0,mask,1], Edge_Net_Subnet3[x,y-3,2,0,mask,1], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(35,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,1,1], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,1,1], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,mask,1], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,mask,1], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,1,1], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(36,52+1)])for y in range(2,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,1,1], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(36,52+1)])for y in range(0,35-2+1)]),
	).to_cnf()
Net3_Subnet1_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,1], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(4,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,1], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35-4+1)]),
	).to_cnf()
Net3_Subnet1_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,1,1], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(36,52+1)])for y in range(0,35-3+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,1,1], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(36,52+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,1], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35-4+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,1], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(4,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,1,1], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,1,1], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(36,52+1)])for y in range(0,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,mask,1], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,mask,1], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(36,52+1)])for y in range(0,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,1,2,mask,1], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,1,2,mask,1], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,2,2,mask,1], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,2,2,mask,1], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet1_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,2,mask,1], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,2,mask,1], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(2,35+1)]),
	).to_cnf()
Net3_Subnet1_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,2,mask,1], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,2,mask,1], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(36,52+1)])for y in range(2,35+1)]),
	).to_cnf()
...
# Net = 3 Subnet = 3 | Left -> Right [44,56] Top -> Bottom [0,35]
# Range R1(48,48,0,35)
# Range R2(52,52,0,35)
### Disable edges outside window
Edge_Net_Subnet3[0:44,0:35+1,0:3+1,0:2+1,0:2+1,3]=exprzeros(57024)
Edge_Net_Subnet3[56:69+1,0:35+1,0:3+1,0:2+1,0:2+1,3]=exprzeros(18144)

### Consistency Constraints
Net3_Subnet3_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,2]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(44,56+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net3_Subnet3_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet3[x,y,z,trend,mask,3]), Edge_Net[x,y,z,trend,mask,2])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(44,56+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net3_Subnet3_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,2,trend,0,3],Xor(Edge_Net_Subnet3[x,y,2,trend,1,3],Edge_Net_Subnet3[x,y,2,trend,2,3])),And(~Edge_Net_Subnet3[x,y,2,trend,0,3],~Edge_Net_Subnet3[x,y,2,trend,1,3],~Edge_Net_Subnet3[x,y,2,trend,2,3]))for x in range(44,56+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net3_Subnet3_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,3,1,0,3],Xor(Edge_Net_Subnet3[x,y,3,1,1,3],Edge_Net_Subnet3[x,y,3,1,2,3])),And(~Edge_Net_Subnet3[x,y,3,1,0,3],~Edge_Net_Subnet3[x,y,3,1,1,3],~Edge_Net_Subnet3[x,y,3,1,2,3]))for x in range(44,56+1)])for y in range(0,35+1)]).to_cnf()
Net3_Subnet3_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,1,trend,2,3],Xor(Edge_Net_Subnet3[x,y,1,trend,0,3],Edge_Net_Subnet3[x,y,1,trend,1,3])),And(~Edge_Net_Subnet3[x,y,1,trend,2,3],~Edge_Net_Subnet3[x,y,1,trend,0,3],~Edge_Net_Subnet3[x,y,1,trend,1,3]))for x in range(44,56+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net3_Subnet3_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,1,3], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,2,s2])for s2 in range(0,3)]))for trend in range(0,1+1)])for x in range(44,56+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,1,3], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,2,s2])for s2 in range(3+1,7)]))for trend in range(0,1+1)])for x in range(44,56+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,2,3], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,1,s2])for s2 in range(0,3)]))for trend in range(0,1+1)])for x in range(44,56+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,2,3], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,1,s2])for s2 in range(3+1,7)]))for trend in range(0,1+1)])for x in range(44,56+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net3_Subnet3_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,1,1,1,3], ~Edge_Net_Subnet3[x-1,y,1,1,1,3]), And(Edge_Net_Subnet3[x+1,y,1,1,1,3], Edge_Net_Subnet3[x+2,y,1,1,1,3], Edge_Net_Subnet3[x+3,y,1,1,1,3], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,1,1,1,3], ~Edge_Net_Subnet3[x+1,y,1,1,1,3]), And(Edge_Net_Subnet3[x-1,y,1,1,1,3], Edge_Net_Subnet3[x-2,y,1,1,1,3], Edge_Net_Subnet3[x-3,y,1,1,1,3], ))for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,1,1,3], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,1,1,3], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,1,1,3], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(44,56+1)])for y in range(0,32+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,1,1,3], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(44,56+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3]), And(Edge_Net_Subnet3[x,y+1,1,0,0,3], Edge_Net_Subnet3[x,y+2,1,0,0,3], Edge_Net_Subnet3[x,y+3,1,0,0,3], ))for x in range(44,56+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3]), And(Edge_Net_Subnet3[x,y-1,1,0,0,3], Edge_Net_Subnet3[x,y-2,1,0,0,3], Edge_Net_Subnet3[x,y-3,1,0,0,3], ))for x in range(44,56+1)])for y in range(35,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge_Net_Subnet3[x,y-1,1,0,0,3]), And(Edge_Net_Subnet3[x,y+1,1,0,0,3], Edge_Net_Subnet3[x,y+2,1,0,0,3], Edge_Net_Subnet3[x,y+3,1,0,0,3], ))for x in range(44,56+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge_Net_Subnet3[x,y+1,1,0,0,3]), And(Edge_Net_Subnet3[x,y-1,1,0,0,3], Edge_Net_Subnet3[x,y-2,1,0,0,3], Edge_Net_Subnet3[x,y-3,1,0,0,3], ))for x in range(44,56+1)])for y in range(0+3,35-1+1)])
	).to_cnf()
Net3_Subnet3_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(44,56+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(44,56+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ))for x in range(44,56+1)])for y in range(35-1,35-1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+2,1,0,0], ~Edge[x,y+1,1,0,0], ))for x in range(44,56+1)])for y in range(35-2,35-2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(44,56+1)])for y in range(0+3,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,3], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(44,56+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net3_Subnet3_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,0,0,3], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,0,0,3], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	).to_cnf()
...
Net3_Subnet3_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,mask,3], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,32+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,mask,3], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,mask,3], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,mask,3], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,1,3], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(44,56+1)])for y in range(0,33+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,1,3], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(44,56+1)])for y in range(2,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,1,3], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,1,3], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,2,1,mask,3], ~Edge_Net_Subnet3[x+1,y,2,1,mask,3]), And(Edge_Net_Subnet3[x-1,y,2,1,mask,3], Edge_Net_Subnet3[x-2,y,2,1,mask,3], Edge_Net_Subnet3[x-3,y,2,1,mask,3], Edge_Net_Subnet3[x-4,y,2,1,mask,3], Edge_Net_Subnet3[x-5,y,2,1,mask,3], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,3], And(Edge_Net_Subnet3[x-1,y,2,1,mask,3], Edge_Net_Subnet3[x-2,y,2,1,mask,3], Edge_Net_Subnet3[x-3,y,2,1,mask,3], Edge_Net_Subnet3[x-4,y,2,1,mask,3], Edge_Net_Subnet3[x-5,y,2,1,mask,3], ))for mask in range(1,2+1)])for x in range(44,44+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,3], And(Edge_Net_Subnet3[x+1,y,2,1,mask,3], Edge_Net_Subnet3[x+2,y,2,1,mask,3], Edge_Net_Subnet3[x+3,y,2,1,mask,3], Edge_Net_Subnet3[x+4,y,2,1,mask,3], Edge_Net_Subnet3[x+5,y,2,1,mask,3], ))for mask in range(1,2+1)])for x in range(56-1,44)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,3], ~Edge_Net_Subnet3[x,y-1,2,0,mask,3]), And(Edge_Net_Subnet3[x,y+1,2,0,mask,3], Edge_Net_Subnet3[x,y+2,2,0,mask,3], Edge_Net_Subnet3[x,y+3,2,0,mask,3], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,3], ~Edge_Net_Subnet3[x,y+1,2,0,mask,3]), And(Edge_Net_Subnet3[x,y-1,2,0,mask,3], Edge_Net_Subnet3[x,y-2,2,0,mask,3], Edge_Net_Subnet3[x,y-3,2,0,mask,3], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0+3,35-1+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet3[x,y,2,0,mask,3], And(Edge_Net_Subnet3[x,y+1,2,0,mask,3], Edge_Net_Subnet3[x,y+2,2,0,mask,3], Edge_Net_Subnet3[x,y+3,2,0,mask,3], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet3[x,y,2,0,mask,3], And(Edge_Net_Subnet3[x,y-1,2,0,mask,3], Edge_Net_Subnet3[x,y-2,2,0,mask,3], Edge_Net_Subnet3[x,y-3,2,0,mask,3], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(35,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,1,3], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,1,3], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,mask,3], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,mask,3], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,1,3], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(44,56+1)])for y in range(2,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,1,3], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(44,56+1)])for y in range(0,35-2+1)]),
	).to_cnf()
Net3_Subnet3_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,3], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(4,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,3], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35-4+1)]),
	).to_cnf()
Net3_Subnet3_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,1,3], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(44,56+1)])for y in range(0,35-3+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,1,3], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(44,56+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,3], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35-4+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,3], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(4,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,1,3], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,1,3], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(44,56+1)])for y in range(0,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,mask,3], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,mask,3], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(44,56+1)])for y in range(0,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,1,2,mask,3], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,1,2,mask,3], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,2,2,mask,3], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,2,2,mask,3], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet3_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,2,mask,3], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,2,mask,3], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(2,35+1)]),
	).to_cnf()
Net3_Subnet3_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,2,mask,3], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,2,mask,3], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(44,56+1)])for y in range(2,35+1)]),
	).to_cnf()
...
### Routability Constraints
Net3_Subnet3_R1 = And(
	RConstraints.R1(Edge_Net_Subnet3,[48,0,0,0, 48,1,0,0, 48,2,0,0, 48,3,0,0, 48,4,0,0, 48,5,0,0, 48,6,0,0, 48,7,0,0, 48,8,0,0, 48,9,0,0, 48,10,0,0, 48,11,0,0, 48,12,0,0, 48,13,0,0, 48,14,0,0, 48,15,0,0, 48,16,0,0, 48,17,0,0, 48,18,0,0, 48,19,0,0, 48,20,0,0, 48,21,0,0, 48,22,0,0, 48,23,0,0, 48,24,0,0, 48,25,0,0, 48,26,0,0, 48,27,0,0, 48,28,0,0, 48,29,0,0, 48,30,0,0, 48,31,0,0, 48,32,0,0, 48,33,0,0, 48,34,0,0, 48,35,0,0, ],36,44,0,1,56,35,3,3),
	RConstraints.R1(Edge_Net_Subnet3,[52,0,0,0, 52,1,0,0, 52,2,0,0, 52,3,0,0, 52,4,0,0, 52,5,0,0, 52,6,0,0, 52,7,0,0, 52,8,0,0, 52,9,0,0, 52,10,0,0, 52,11,0,0, 52,12,0,0, 52,13,0,0, 52,14,0,0, 52,15,0,0, 52,16,0,0, 52,17,0,0, 52,18,0,0, 52,19,0,0, 52,20,0,0, 52,21,0,0, 52,22,0,0, 52,23,0,0, 52,24,0,0, 52,25,0,0, 52,26,0,0, 52,27,0,0, 52,28,0,0, 52,29,0,0, 52,30,0,0, 52,31,0,0, 52,32,0,0, 52,33,0,0, 52,34,0,0, 52,35,0,0, ],36,44,0,1,56,35,3,3),
	).to_cnf()
Net3_Subnet3_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet3,Edge,Edge_Net,[48,0,0, 48,1,0, 48,2,0, 48,3,0, 48,4,0, 48,5,0, 48,6,0, 48,7,0, 48,8,0, 48,9,0, 48,10,0, 48,11,0, 48,12,0, 48,13,0, 48,14,0, 48,15,0, 48,16,0, 48,17,0, 48,18,0, 48,19,0, 48,20,0, 48,21,0, 48,22,0, 48,23,0, 48,24,0, 48,25,0, 48,26,0, 48,27,0, 48,28,0, 48,29,0, 48,30,0, 48,31,0, 48,32,0, 48,33,0, 48,34,0, 48,35,0, 52,0,0, 52,1,0, 52,2,0, 52,3,0, 52,4,0, 52,5,0, 52,6,0, 52,7,0, 52,8,0, 52,9,0, 52,10,0, 52,11,0, 52,12,0, 52,13,0, 52,14,0, 52,15,0, 52,16,0, 52,17,0, 52,18,0, 52,19,0, 52,20,0, 52,21,0, 52,22,0, 52,23,0, 52,24,0, 52,25,0, 52,26,0, 52,27,0, 52,28,0, 52,29,0, 52,30,0, 52,31,0, 52,32,0, 52,33,0, 52,34,0, 52,35,0, ],72,44,0,0,56,35,3,3,2),
	)
Net3_Subnet3_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,2],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(0,1+1)])for x in range(44,56+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	).to_cnf()
...
# Net = 3 Subnet = 5 | Left -> Right [48,60] Top -> Bottom [0,35]
# Range R1(52,52,0,35)
# Range R2(56,56,0,35)
### Disable edges outside window
Edge_Net_Subnet3[0:48,0:35+1,0:3+1,0:2+1,0:2+1,5]=exprzeros(62208)
Edge_Net_Subnet3[60:69+1,0:35+1,0:3+1,0:2+1,0:2+1,5]=exprzeros(12960)

### Consistency Constraints
Net3_Subnet5_C1 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net[x,y,z,trend,mask,2]), Edge[x,y,z,trend,mask])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(48,60+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net3_Subnet5_C2 = And(*[And(*[And(*[And(*[And(*[Implies( Or(Edge_Net_Subnet3[x,y,z,trend,mask,5]), Edge_Net[x,y,z,trend,mask,2])for mask in range(0,2+1)])for trend in range(0,2+1)])for x in range(48,60+1)])for y in range(0,35+1)])for z in range(0,3+1)]).to_cnf()
Net3_Subnet5_C3_ME1_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,2,trend,0,5],Xor(Edge_Net_Subnet3[x,y,2,trend,1,5],Edge_Net_Subnet3[x,y,2,trend,2,5])),And(~Edge_Net_Subnet3[x,y,2,trend,0,5],~Edge_Net_Subnet3[x,y,2,trend,1,5],~Edge_Net_Subnet3[x,y,2,trend,2,5]))for x in range(48,60+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net3_Subnet5_C4_MINT1_Mask = And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,3,1,0,5],Xor(Edge_Net_Subnet3[x,y,3,1,1,5],Edge_Net_Subnet3[x,y,3,1,2,5])),And(~Edge_Net_Subnet3[x,y,3,1,0,5],~Edge_Net_Subnet3[x,y,3,1,1,5],~Edge_Net_Subnet3[x,y,3,1,2,5]))for x in range(48,60+1)])for y in range(0,35+1)]).to_cnf()
Net3_Subnet5_C5_AIL2GIL_Mask = And(*[And(*[And(*[Or(And(Edge_Net_Subnet3[x,y,1,trend,2,5],Xor(Edge_Net_Subnet3[x,y,1,trend,0,5],Edge_Net_Subnet3[x,y,1,trend,1,5])),And(~Edge_Net_Subnet3[x,y,1,trend,2,5],~Edge_Net_Subnet3[x,y,1,trend,0,5],~Edge_Net_Subnet3[x,y,1,trend,1,5]))for x in range(48,60+1)])for y in range(0,35+1)])for trend in range(0,1+1)]).to_cnf()
Net3_Subnet5_C6 = And(
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,1,5], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,2,s2])for s2 in range(0,5)]))for trend in range(0,1+1)])for x in range(48,60+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,1,5], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,2,s2])for s2 in range(5+1,7)]))for trend in range(0,1+1)])for x in range(48,60+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,2,5], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,1,s2])for s2 in range(0,5)]))for trend in range(0,1+1)])for x in range(48,60+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
And(*[And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,z,trend,2,5], And(*[And(~Edge_Net_Subnet3[x,y,z,trend,1,s2])for s2 in range(5+1,7)]))for trend in range(0,1+1)])for x in range(48,60+1)])for y in range(0,35+1)])for z in range(2,3+1)]),
).to_cnf()
...
Net3_Subnet5_DR_GIL_HorMinWidth = And(
	And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,1,1,1,5], ~Edge_Net_Subnet3[x-1,y,1,1,1,5]), And(Edge_Net_Subnet3[x+1,y,1,1,1,5], Edge_Net_Subnet3[x+2,y,1,1,1,5], Edge_Net_Subnet3[x+3,y,1,1,1,5], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,1,1,1,5], ~Edge_Net_Subnet3[x+1,y,1,1,1,5]), And(Edge_Net_Subnet3[x-1,y,1,1,1,5], Edge_Net_Subnet3[x-2,y,1,1,1,5], Edge_Net_Subnet3[x-3,y,1,1,1,5], ))for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_GIL_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,1,1,5], ~Edge[x-1,y,1,1,1]), And(~Edge[x-1,y,1,1,1], ~Edge[x-2,y,1,1,1], ~Edge[x-3,y,1,1,1], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,1,1,5], ~Edge[x+1,y,1,1,1]), And(~Edge[x+1,y,1,1,1], ~Edge[x+2,y,1,1,1], ~Edge[x+3,y,1,1,1], ))for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_GIL_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,1,1,5], And(~Edge[x,y+1,1,1,1], ~Edge[x,y+2,1,1,1], ~Edge[x,y+3,1,1,1], ))for x in range(48,60+1)])for y in range(0,32+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,1,1,5], And(~Edge[x,y-1,1,1,1], ~Edge[x,y-2,1,1,1], ~Edge[x,y-3,1,1,1], ))for x in range(48,60+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_AIL2_VerMinWidth = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5]), And(Edge_Net_Subnet3[x,y+1,1,0,0,5], Edge_Net_Subnet3[x,y+2,1,0,0,5], Edge_Net_Subnet3[x,y+3,1,0,0,5], ))for x in range(48,60+1)])for y in range(0,0+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5]), And(Edge_Net_Subnet3[x,y-1,1,0,0,5], Edge_Net_Subnet3[x,y-2,1,0,0,5], Edge_Net_Subnet3[x,y-3,1,0,0,5], ))for x in range(48,60+1)])for y in range(35,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge_Net_Subnet3[x,y-1,1,0,0,5]), And(Edge_Net_Subnet3[x,y+1,1,0,0,5], Edge_Net_Subnet3[x,y+2,1,0,0,5], Edge_Net_Subnet3[x,y+3,1,0,0,5], ))for x in range(48,60+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge_Net_Subnet3[x,y+1,1,0,0,5]), And(Edge_Net_Subnet3[x,y-1,1,0,0,5], Edge_Net_Subnet3[x,y-2,1,0,0,5], Edge_Net_Subnet3[x,y-3,1,0,0,5], ))for x in range(48,60+1)])for y in range(0+3,35-1+1)])
	).to_cnf()
Net3_Subnet5_DR_AIL2_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ))for x in range(48,60+1)])for y in range(1,1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-2,1,0,0], ~Edge[x,y-1,1,0,0], ))for x in range(48,60+1)])for y in range(2,2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ))for x in range(48,60+1)])for y in range(35-1,35-1+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+2,1,0,0], ~Edge[x,y+1,1,0,0], ))for x in range(48,60+1)])for y in range(35-2,35-2+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge[x,y-1,1,0,0]), And(~Edge[x,y-1,1,0,0], ~Edge[x,y-2,1,0,0], ~Edge[x,y-3,1,0,0], ))for x in range(48,60+1)])for y in range(0+3,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,1,0,0,5], ~Edge[x,y+1,1,0,0]), And(~Edge[x,y+1,1,0,0], ~Edge[x,y+2,1,0,0], ~Edge[x,y+3,1,0,0], ))for x in range(48,60+1)])for y in range(0,35-3+1)])
	).to_cnf()
Net3_Subnet5_DR_VerAIL2_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,0,0,5], And(~Edge[x+1,y,1,0,0], ~Edge[x+2,y,1,0,0], ~Edge[x+3,y,1,0,0], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,0,0,5], And(~Edge[x-1,y,1,0,0], ~Edge[x-2,y,1,0,0], ~Edge[x-3,y,1,0,0], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	).to_cnf()
...
Net3_Subnet5_DR_MINT1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,mask,5], And(~Edge[x,y+1,3,1,mask], ~Edge[x,y+2,3,1,mask], ~Edge[x,y+3,3,1,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,32+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,mask,5], And(~Edge[x,y-1,3,1,mask], ~Edge[x,y-2,3,1,mask], ~Edge[x,y-3,3,1,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_MINT1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,mask,5], ~Edge[x-1,y,3,1,mask]), And(~Edge[x-1,y,3,1,mask], ~Edge[x-2,y,3,1,mask], ~Edge[x-3,y,3,1,mask], ~Edge[x-4,y,3,1,mask], ~Edge[x-5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,mask,5], ~Edge[x+1,y,3,1,mask]), And(~Edge[x+1,y,3,1,mask], ~Edge[x+2,y,3,1,mask], ~Edge[x+3,y,3,1,mask], ~Edge[x+4,y,3,1,mask], ~Edge[x+5,y,3,1,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_MINT1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,1,5], And(~Edge[x,y+1,3,1,2], ~Edge[x,y+2,3,1,2], ))for x in range(48,60+1)])for y in range(0,33+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,3,1,1,5], And(~Edge[x,y-1,3,1,2], ~Edge[x,y-2,3,1,2], ))for x in range(48,60+1)])for y in range(2,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_MINT1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,1,5], ~Edge[x-1,y,3,1,1]), And(~Edge[x-1,y,3,1,2], ~Edge[x-2,y,3,1,2], ~Edge[x-3,y,3,1,2], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,3,1,1,5], ~Edge[x+1,y,3,1,1]), And(~Edge[x+1,y,3,1,2], ~Edge[x+2,y,3,1,2], ~Edge[x+3,y,3,1,2], ))for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_M1AB_MinWidth = And(
	...
	And(*[And(*[And(*[Implies(And(Edge_Net_Subnet3[x,y,2,1,mask,5], ~Edge_Net_Subnet3[x+1,y,2,1,mask,5]), And(Edge_Net_Subnet3[x-1,y,2,1,mask,5], Edge_Net_Subnet3[x-2,y,2,1,mask,5], Edge_Net_Subnet3[x-3,y,2,1,mask,5], Edge_Net_Subnet3[x-4,y,2,1,mask,5], Edge_Net_Subnet3[x-5,y,2,1,mask,5], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,5], And(Edge_Net_Subnet3[x-1,y,2,1,mask,5], Edge_Net_Subnet3[x-2,y,2,1,mask,5], Edge_Net_Subnet3[x-3,y,2,1,mask,5], Edge_Net_Subnet3[x-4,y,2,1,mask,5], Edge_Net_Subnet3[x-5,y,2,1,mask,5], ))for mask in range(1,2+1)])for x in range(48,48+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,5], And(Edge_Net_Subnet3[x+1,y,2,1,mask,5], Edge_Net_Subnet3[x+2,y,2,1,mask,5], Edge_Net_Subnet3[x+3,y,2,1,mask,5], Edge_Net_Subnet3[x+4,y,2,1,mask,5], Edge_Net_Subnet3[x+5,y,2,1,mask,5], ))for mask in range(1,2+1)])for x in range(60-1,48)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,5], ~Edge_Net_Subnet3[x,y-1,2,0,mask,5]), And(Edge_Net_Subnet3[x,y+1,2,0,mask,5], Edge_Net_Subnet3[x,y+2,2,0,mask,5], Edge_Net_Subnet3[x,y+3,2,0,mask,5], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0+1,35-4+1+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,5], ~Edge_Net_Subnet3[x,y+1,2,0,mask,5]), And(Edge_Net_Subnet3[x,y-1,2,0,mask,5], Edge_Net_Subnet3[x,y-2,2,0,mask,5], Edge_Net_Subnet3[x,y-3,2,0,mask,5], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0+3,35-1+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet3[x,y,2,0,mask,5], And(Edge_Net_Subnet3[x,y+1,2,0,mask,5], Edge_Net_Subnet3[x,y+2,2,0,mask,5], Edge_Net_Subnet3[x,y+3,2,0,mask,5], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,0+1)]),
	And(*[And(*[And(*[ Implies( Edge_Net_Subnet3[x,y,2,0,mask,5], And(Edge_Net_Subnet3[x,y-1,2,0,mask,5], Edge_Net_Subnet3[x,y-2,2,0,mask,5], Edge_Net_Subnet3[x,y-3,2,0,mask,5], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(35,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_HorM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,1,5], ~Edge[x-1,y,2,1,1]), And(~Edge[x-1,y,2,1,2], ~Edge[x-2,y,2,1,2], ~Edge[x-3,y,2,1,2], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,1,5], ~Edge[x+1,y,2,1,1]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ))for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_HorM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,mask,5], ~Edge[x-1,y,2,1,mask]), And(~Edge[x-1,y,2,1,mask], ~Edge[x-2,y,2,1,mask], ~Edge[x-3,y,2,1,mask], ~Edge[x-4,y,2,1,mask], ~Edge[x-5,y,2,1,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,1,mask,5], ~Edge[x+1,y,2,1,mask]), And(~Edge[x+1,y,2,1,2], ~Edge[x+2,y,2,1,2], ~Edge[x+3,y,2,1,2], ~Edge[x+4,y,2,1,2], ~Edge[x+5,y,2,1,2], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_VerM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,1,5], ~Edge[x,y-1,2,0,1]), And(~Edge[x,y-1,2,0,2], ~Edge[x,y-2,2,0,2], ))for x in range(48,60+1)])for y in range(2,35+1)]),
	And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,1,5], ~Edge[x,y+1,2,0,1]), And(~Edge[x,y+1,2,0,2], ~Edge[x,y+2,2,0,2], ))for x in range(48,60+1)])for y in range(0,35-2+1)]),
	).to_cnf()
Net3_Subnet5_DR_VerM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,5], ~Edge[x,y-1,2,0,mask]), And(~Edge[x,y-1,2,0,mask], ~Edge[x,y-2,2,0,mask], ~Edge[x,y-3,2,0,mask], ~Edge[x,y-4,2,0,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(4,35+1)]),
	And(*[And(*[And(*[ Implies( And(Edge_Net_Subnet3[x,y,2,0,mask,5], ~Edge[x,y+1,2,0,mask]), And(~Edge[x,y+1,2,0,mask], ~Edge[x,y+2,2,0,mask], ~Edge[x,y+3,2,0,mask], ~Edge[x,y+4,2,0,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35-4+1)]),
	).to_cnf()
Net3_Subnet5_DR_HorM1_DiffMask_VerMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,1,5], And(~Edge[x,y+1,2,1,2], ~Edge[x,y+2,2,1,2], ~Edge[x,y+3,2,1,2], ))for x in range(48,60+1)])for y in range(0,35-3+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,1,5], And(~Edge[x,y-1,2,1,2], ~Edge[x,y-2,2,1,2], ~Edge[x,y-3,2,1,2], ))for x in range(48,60+1)])for y in range(3,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_HorM1_SameMask_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,5], And(~Edge[x,y+1,2,1,mask], ~Edge[x,y+2,2,1,mask], ~Edge[x,y+3,2,1,mask], ~Edge[x,y+4,2,1,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35-4+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,1,mask,5], And(~Edge[x,y-1,2,1,mask], ~Edge[x,y-2,2,1,mask], ~Edge[x,y-3,2,1,mask], ~Edge[x,y-4,2,1,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(4,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_VerM1_DiffMask_HorMinSpacing = And(
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,1,5], And(~Edge[x+1,y,2,0,2], ~Edge[x+2,y,2,0,2], ~Edge[x+3,y,2,0,2], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,1,5], And(~Edge[x-1,y,2,0,2], ~Edge[x-2,y,2,0,2], ~Edge[x-3,y,2,0,2], ))for x in range(48,60+1)])for y in range(0,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_VerM1_SameMask_HorMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,mask,5], And(~Edge[x+1,y,2,0,mask], ~Edge[x+2,y,2,0,mask], ~Edge[x+3,y,2,0,mask], ~Edge[x+4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,0,mask,5], And(~Edge[x-1,y,2,0,mask], ~Edge[x-2,y,2,0,mask], ~Edge[x-3,y,2,0,mask], ~Edge[x-4,y,2,0,mask], ))for mask in range(1,2+1)])for x in range(48,60+1)])for y in range(0,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_V0_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,1,2,mask,5], And(~Edge[x-1,y,1,2,mask], ~Edge[x-2,y,1,2,mask], ~Edge[x-3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,1,2,mask,5], And(~Edge[x+1,y,1,2,mask], ~Edge[x+2,y,1,2,mask], ~Edge[x+3,y,1,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_V1_HorMinSpacing = And(
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,2,2,mask,5], And(~Edge[x-1,y,2,2,mask], ~Edge[x-2,y,2,2,mask], ~Edge[x-3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(0,35+1)]),
	And(*[And(*[And(*[ Implies(Edge_Net_Subnet3[x,y,2,2,mask,5], And(~Edge[x+1,y,2,2,mask], ~Edge[x+2,y,2,2,mask], ~Edge[x+3,y,2,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(0,35+1)])
	).to_cnf()
Net3_Subnet5_DR_V0_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,2,mask,5], And(~Edge[x,y+1,1,2,mask], ~Edge[x,y+2,1,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,1,2,mask,5], And(~Edge[x,y-1,1,2,mask], ~Edge[x,y-2,1,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(2,35+1)]),
	).to_cnf()
Net3_Subnet5_DR_V1_VerMinSpacing = And(
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,2,mask,5], And(~Edge[x,y+1,2,2,mask], ~Edge[x,y+2,2,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(0,33+1)]),
	And(*[And(*[And(*[Implies(Edge_Net_Subnet3[x,y,2,2,mask,5], And(~Edge[x,y-1,2,2,mask], ~Edge[x,y-2,2,2,mask], ))for mask in range(2,2+1)])for x in range(48,60+1)])for y in range(2,35+1)]),
	).to_cnf()
...
### Routability Constraints
Net3_Subnet5_R1 = And(
	RConstraints.R1(Edge_Net_Subnet3,[52,0,0,0, 52,1,0,0, 52,2,0,0, 52,3,0,0, 52,4,0,0, 52,5,0,0, 52,6,0,0, 52,7,0,0, 52,8,0,0, 52,9,0,0, 52,10,0,0, 52,11,0,0, 52,12,0,0, 52,13,0,0, 52,14,0,0, 52,15,0,0, 52,16,0,0, 52,17,0,0, 52,18,0,0, 52,19,0,0, 52,20,0,0, 52,21,0,0, 52,22,0,0, 52,23,0,0, 52,24,0,0, 52,25,0,0, 52,26,0,0, 52,27,0,0, 52,28,0,0, 52,29,0,0, 52,30,0,0, 52,31,0,0, 52,32,0,0, 52,33,0,0, 52,34,0,0, 52,35,0,0, ],36,48,0,1,60,35,3,5),
	RConstraints.R1(Edge_Net_Subnet3,[56,0,0,0, 56,1,0,0, 56,2,0,0, 56,3,0,0, 56,4,0,0, 56,5,0,0, 56,6,0,0, 56,7,0,0, 56,8,0,0, 56,9,0,0, 56,10,0,0, 56,11,0,0, 56,12,0,0, 56,13,0,0, 56,14,0,0, 56,15,0,0, 56,16,0,0, 56,17,0,0, 56,18,0,0, 56,19,0,0, 56,20,0,0, 56,21,0,0, 56,22,0,0, 56,23,0,0, 56,24,0,0, 56,25,0,0, 56,26,0,0, 56,27,0,0, 56,28,0,0, 56,29,0,0, 56,30,0,0, 56,31,0,0, 56,32,0,0, 56,33,0,0, 56,34,0,0, 56,35,0,0, ],36,48,0,1,60,35,3,5),
	).to_cnf()
Net3_Subnet5_R2 = And(
	RConstraints.R2_R4_V3(Edge_Net_Subnet3,Edge,Edge_Net,[52,0,0, 52,1,0, 52,2,0, 52,3,0, 52,4,0, 52,5,0, 52,6,0, 52,7,0, 52,8,0, 52,9,0, 52,10,0, 52,11,0, 52,12,0, 52,13,0, 52,14,0, 52,15,0, 52,16,0, 52,17,0, 52,18,0, 52,19,0, 52,20,0, 52,21,0, 52,22,0, 52,23,0, 52,24,0, 52,25,0, 52,26,0, 52,27,0, 52,28,0, 52,29,0, 52,30,0, 52,31,0, 52,32,0, 52,33,0, 52,34,0, 52,35,0, 56,0,0, 56,1,0, 56,2,0, 56,3,0, 56,4,0, 56,5,0, 56,6,0, 56,7,0, 56,8,0, 56,9,0, 56,10,0, 56,11,0, 56,12,0, 56,13,0, 56,14,0, 56,15,0, 56,16,0, 56,17,0, 56,18,0, 56,19,0, 56,20,0, 56,21,0, 56,22,0, 56,23,0, 56,24,0, 56,25,0, 56,26,0, 56,27,0, 56,28,0, 56,29,0, 56,30,0, 56,31,0, 56,32,0, 56,33,0, 56,34,0, 56,35,0, ],72,48,0,0,60,35,3,5,2),
	)
Net3_Subnet5_R3 = And(
	And(*[And(*[And(*[And(*[And(*[And(*[Implies(Edge_Net[x,y,z,trend,mask,2],~Edge_Net[x,y,z,trend,mask,net2])for net2 in range(0,1+1)])for x in range(48,60+1)])for y in range(0,35+1)])for z in range(1,3+1)])for trend in range(0,2+1)])for mask in range(0,2+1)]),
	).to_cnf()
